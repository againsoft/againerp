...
**Related:** [WORKFLOW_REGISTRY.md](../../WORKFLOW_REGISTRY.md) · [ACTIVITY_CHATTER_ARCHITECTURE.md](../modules/core/ACTIVITY_CHATTER_ARCHITECTURE.md) · [APPROVAL_ENGINE_ARCHITECTURE.md](./APPROVAL_ENGINE_ARCHITECTURE.md) · [INVENTORY_WORKFLOW.md](../modules/inventory/INVENTORY_WORKFLOW.md) · [PURCHASE_WORKFLOW.md](../modules/purchase/PURCHASE_WORKFLOW.md) · [SALES_WORKFLOW.md](../modules/sales/SALES_WORKFLOW.md) · [CRM_MODULE_ARCHITECTURE.md](../modules/crm/CRM_MODULE_ARCHITECTURE.md)
...
All `workflow_*` tables: `id` (UUID), `company_id`, `created_at`, `updated_at`, `created_by`, `updated_by` per [database/standards.md](../../database/standards.md).
...
Integrates [Activity & Chatter Architecture](../modules/core/ACTIVITY_CHATTER_ARCHITECTURE.md).
...
|--------|-------------------|-----|
| **Ecommerce** | `commerce.order`, `catalog.product`, `commerce.return` | [orders/ARCHITECTURE](../modules/ecommerce/orders/ARCHITECTURE.md) |
| **Inventory** | `inventory.transfer`, `inventory.adjustment`, … | [INVENTORY_WORKFLOW](../modules/inventory/INVENTORY_WORKFLOW.md) |
| **Purchase** | `purchase.order`, `purchase.rfq`, `purchase.bill` | [PURCHASE_WORKFLOW](../modules/purchase/PURCHASE_WORKFLOW.md) |
| **Sales** | `sales.order`, `sales.quotation`, `sales.invoice` | [SALES_WORKFLOW](../modules/sales/SALES_WORKFLOW.md) |
| **CRM** | `crm.lead`, `crm.opportunity`, `crm.task` | [CRM_MODULE](../modules/crm/CRM_MODULE_ARCHITECTURE.md) |
...
Module transitions emit **both** `core.workflow.transitioned` and module-specific events — see [WORKFLOW_REGISTRY.md](../../WORKFLOW_REGISTRY.md).
...
|----------|--------------|
| [WORKFLOW_REGISTRY.md](../../WORKFLOW_REGISTRY.md) | All registered workflows |
| [APPROVAL_ENGINE_ARCHITECTURE.md](./APPROVAL_ENGINE_ARCHITECTURE.md) | Human approval gates |
| [ACTIVITY_CHATTER_ARCHITECTURE.md](../modules/core/ACTIVITY_CHATTER_ARCHITECTURE.md) | Timeline integration |
| [INVENTORY_WORKFLOW.md](../modules/inventory/INVENTORY_WORKFLOW.md) | Inventory state machines |
| [PURCHASE_WORKFLOW.md](../modules/purchase/PURCHASE_WORKFLOW.md) | Purchase state machines |
| [SALES_WORKFLOW.md](../modules/sales/SALES_WORKFLOW.md) | Sales state machines |
| [CRM_MODULE_ARCHITECTURE.md](../modules/crm/CRM_MODULE_ARCHITECTURE.md) | CRM pipelines |
| [modules/ai/AI_OS_ARCHITECTURE.md](../modules/ai/AI_OS_ARCHITECTURE.md) | AI routing |
| [SETTINGS_ARCHITECTURE.md](../modules/core/SETTINGS_ARCHITECTURE.md) | Control Center placement |
