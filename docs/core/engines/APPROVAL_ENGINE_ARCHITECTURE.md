...
**Related:** [WORKFLOW_ENGINE_ARCHITECTURE.md](./WORKFLOW_ENGINE_ARCHITECTURE.md) · [ACTIVITY_CHATTER_ARCHITECTURE.md](../modules/core/ACTIVITY_CHATTER_ARCHITECTURE.md) · [WORKFLOW_REGISTRY.md](../../WORKFLOW_REGISTRY.md) · [PURCHASE_WORKFLOW.md](../modules/purchase/PURCHASE_WORKFLOW.md) · [SALES_WORKFLOW.md](../modules/sales/SALES_WORKFLOW.md) · [INVENTORY_WORKFLOW.md](../modules/inventory/INVENTORY_WORKFLOW.md)
...
|--------|------------------|-----|
| **Catalog / Products** | Price change, publish, archive | [PRODUCT_MASTER](../modules/core/PRODUCT_MASTER_ARCHITECTURE.md) |
| **Inventory** | Adjustment, transfer, batch recall | [INVENTORY_WORKFLOW](../modules/inventory/INVENTORY_WORKFLOW.md) |
| **Purchase** | PO, RFQ award, bill exception, return | [PURCHASE_WORKFLOW](../modules/purchase/PURCHASE_WORKFLOW.md) |
| **Sales** | SO discount, credit limit, refund, credit note | [SALES_WORKFLOW](../modules/sales/SALES_WORKFLOW.md) |
| **Ecommerce** | Manual discount, refund, high-value order | [orders/ARCHITECTURE](../modules/ecommerce/orders/ARCHITECTURE.md) |
| **CRM** | Opportunity won, stage skip | [CRM_MODULE](../modules/crm/CRM_MODULE_ARCHITECTURE.md) |
...
| [ACTIVITY_CHATTER_ARCHITECTURE.md](../modules/core/ACTIVITY_CHATTER_ARCHITECTURE.md) | Timeline |
| [WORKFLOW_REGISTRY.md](../../WORKFLOW_REGISTRY.md) | Registered workflows |
| [INVENTORY_WORKFLOW.md](../modules/inventory/INVENTORY_WORKFLOW.md) | Adjustment approval |
| [PURCHASE_WORKFLOW.md](../modules/purchase/PURCHASE_WORKFLOW.md) | PO approval |
| [SALES_WORKFLOW.md](../modules/sales/SALES_WORKFLOW.md) | SO/refund approval |
| [CRM_MODULE_ARCHITECTURE.md](../modules/crm/CRM_MODULE_ARCHITECTURE.md) | Opportunity gates |
| [PRODUCT_MASTER_ARCHITECTURE.md](../modules/core/PRODUCT_MASTER_ARCHITECTURE.md) | Product publish |
| [modules/ai/AI_OS_ARCHITECTURE.md](../modules/ai/AI_OS_ARCHITECTURE.md) | AI assistant |
