...
> **Prefix:** `crm_*` · Owner: **CRM** · See [MASTER_DATABASE_ARCHITECTURE §28](../../database/MASTER_DATABASE_ARCHITECTURE.md#28-future-compatibility)
...
All `crm_*` tables include: `id` (UUID), `company_id`, `created_at`, `updated_at`, `deleted_at`, `created_by`, `updated_by` per [standards.md](../../database/standards.md).
