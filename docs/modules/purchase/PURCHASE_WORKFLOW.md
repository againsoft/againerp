...
Central reference for all Purchase workflow approvals. Integrates [Approval Engine](../../core/engines/APPROVAL_ENGINE_ARCHITECTURE.md) and [Workflow Engine](../../core/engines/WORKFLOW_ENGINE_ARCHITECTURE.md).
...
**Prototype:** [ui-prototype/inventory/PurchaseSuggestions.md](../../ui-prototype/inventory/PurchaseSuggestions.md)

---

## 8. Activity Tracking

Integrates [Activity & Chatter Architecture](../core/ACTIVITY_CHATTER_ARCHITECTURE.md). Every Purchase workflow transition produces an auditable Activity record.
...
| [PRODUCT_MASTER_ARCHITECTURE.md](../core/PRODUCT_MASTER_ARCHITECTURE.md) | PO line product refs |
