...
**Related:** [SALES_MODULE_ARCHITECTURE.md](./SALES_MODULE_ARCHITECTURE.md) · [INVENTORY_WORKFLOW.md](../inventory/INVENTORY_WORKFLOW.md) · [PURCHASE_WORKFLOW.md](../purchase/PURCHASE_WORKFLOW.md) · [ACTIVITY_CHATTER_ARCHITECTURE.md](../core/ACTIVITY_CHATTER_ARCHITECTURE.md) · [WORKFLOW_REGISTRY.md](../../WORKFLOW_REGISTRY.md)
...
Central reference for all Sales workflow approvals. Integrates [Approval Engine](../../core/engines/APPROVAL_ENGINE_ARCHITECTURE.md) and [Workflow Engine](../../core/engines/WORKFLOW_ENGINE_ARCHITECTURE.md).
...
Integrates [Activity & Chatter Architecture](../core/ACTIVITY_CHATTER_ARCHITECTURE.md). Every Sales workflow transition produces an auditable Activity record.
...
| [PRODUCT_MASTER_ARCHITECTURE.md](../core/PRODUCT_MASTER_ARCHITECTURE.md) | Line item product refs |
