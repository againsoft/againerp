...
Per [database/multi-company.md](../../database/multi-company.md) and SaaS platform architecture.
...
Every permission-checked action logged per [ACTIVITY_CHATTER_ARCHITECTURE.md](../core/ACTIVITY_CHATTER_ARCHITECTURE.md) and platform audit standards.
...
Per [AI_OS_ARCHITECTURE.md](../ai/AI_OS_ARCHITECTURE.md) — AI inherits user permissions.
...
**Registration:** Add HR permission groups to Core Permission Registry on module install per [PERMISSION_SYSTEM_ARCHITECTURE.md](../../core/PERMISSION_SYSTEM_ARCHITECTURE.md).
