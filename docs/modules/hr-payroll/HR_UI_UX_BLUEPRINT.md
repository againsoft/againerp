...
> **Governance:** [UI_UX_DESIGN_STANDARDS.md](../../ui-ux/UI_UX_DESIGN_STANDARDS.md) · [ENTERPRISE_UI_ARCHITECTURE.md](../../ui-ux/ENTERPRISE_UI_ARCHITECTURE.md) · [mobile-first.md](../../ui-ux/mobile-first.md) · [PROJECT_COMMON_RULES.md](../../PROJECT_COMMON_RULES.md)
...
**Platform shell** remains shared with all modules per [ENTERPRISE_UI_ARCHITECTURE.md](../../ui-ux/ENTERPRISE_UI_ARCHITECTURE.md) — HR does not invent a separate app chrome.
...
Per [PROJECT_COMMON_RULES.md](../../PROJECT_COMMON_RULES.md) — **list page + right Sheet drawer only**:
...
Every list grid includes **Activity** column → `ActivityTriggerButton` → Global Activity Drawer per [ACTIVITY_CHATTER_ARCHITECTURE.md](../core/ACTIVITY_CHATTER_ARCHITECTURE.md).
...
Per [mobile-first.md](../../ui-ux/mobile-first.md).
