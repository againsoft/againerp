...
**Registry alignment:** This document is the HR & Payroll profile for [API_REGISTRY.md](../../API_REGISTRY.md). Concrete route tables ship in module `API.md` at implementation gate.
...
| 3 | **Consistent envelope** | `{ data, meta, links, errors }` per [API_REGISTRY](../../API_REGISTRY.md) |
...
Per [HR_PERMISSION_MATRIX.md](./HR_PERMISSION_MATRIX.md) and [PERMISSION_SYSTEM_ARCHITECTURE.md](../../core/PERMISSION_SYSTEM_ARCHITECTURE.md).
...
Per [AI_OS_ARCHITECTURE.md](../ai/AI_OS_ARCHITECTURE.md) — AI acts through **tools** mapped to HR services.
...
| [API_REGISTRY.md](../../API_REGISTRY.md) | Global API standards |
