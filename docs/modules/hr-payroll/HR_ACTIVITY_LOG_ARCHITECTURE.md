...
**Platform rule:** Any entity with `entity_type` registration **must** support Activity Drawer per [ACTIVITY_CHATTER_ARCHITECTURE.md](../core/ACTIVITY_CHATTER_ARCHITECTURE.md).
