...
> **Governance:** [GOVERNANCE.md](../../GOVERNANCE.md) · [PROJECT_COMMON_RULES.md](../../PROJECT_COMMON_RULES.md) · [MASTER_MODULE_ARCHITECTURE.md](../../MASTER_MODULE_ARCHITECTURE.md) · [UNIVERSAL_MODULE_FRAMEWORK.md](../../UNIVERSAL_MODULE_FRAMEWORK.md)
...
| **26** | [../../design-system/HR_DESIGN_SYSTEM_SPECIFICATION.md](../../design-system/HR_DESIGN_SYSTEM_SPECIFICATION.md) | Design tokens, components, patterns — global DS seed | Draft | UI blueprint, Figma blueprint, all uiux arch docs | Product / Design | P0 |
...
| Document | Relevance |
|----------|-----------|
| [SAAS_PLATFORM_ARCHITECTURE.md](../../SAAS_PLATFORM_ARCHITECTURE.md) | Multi-tenant, plan gating |
| [AI_OS_ARCHITECTURE.md](../ai/AI_OS_ARCHITECTURE.md) | AI platform service |
| [APPROVAL_ENGINE_ARCHITECTURE.md](../../core/engines/APPROVAL_ENGINE_ARCHITECTURE.md) | Approval flows |
| [NOTIFICATION_ENGINE_ARCHITECTURE.md](../../core/engines/NOTIFICATION_ENGINE_ARCHITECTURE.md) | Notification delivery |
| [ACTIVITY_CHATTER_ARCHITECTURE.md](../core/ACTIVITY_CHATTER_ARCHITECTURE.md) | Activity timeline |
| [database/multi-company.md](../../database/multi-company.md) | Company/branch scope |
| [UI_UX_DESIGN_STANDARDS.md](../../ui-ux/UI_UX_DESIGN_STANDARDS.md) | Drawer CRUD, mobile-first |
...
| **Pre-code** | All P0 docs **Ready** per [GOVERNANCE.md](../../GOVERNANCE.md) |
...
Per [database/multi-company.md](../../database/multi-company.md) and Master Architecture.
...
| 26 | HR Design System Specification | [../../design-system/HR_DESIGN_SYSTEM_SPECIFICATION.md](../../design-system/HR_DESIGN_SYSTEM_SPECIFICATION.md) |
...
| Document | Link |
|----------|------|
| Project common rules | [PROJECT_COMMON_RULES.md](../../PROJECT_COMMON_RULES.md) |
| Governance | [GOVERNANCE.md](../../GOVERNANCE.md) |
| Master module architecture | [MASTER_MODULE_ARCHITECTURE.md](../../MASTER_MODULE_ARCHITECTURE.md) |
| Universal module framework | [UNIVERSAL_MODULE_FRAMEWORK.md](../../UNIVERSAL_MODULE_FRAMEWORK.md) |
| Module dependency map | [MODULE_DEPENDENCY_MAP.md](../../MODULE_DEPENDENCY_MAP.md) |
| SaaS platform | [SAAS_PLATFORM_ARCHITECTURE.md](../../SAAS_PLATFORM_ARCHITECTURE.md) |

### Core engines

| Engine | Link |
|--------|------|
| Approval Engine | [APPROVAL_ENGINE_ARCHITECTURE.md](../../core/engines/APPROVAL_ENGINE_ARCHITECTURE.md) |
| Notification Engine | [NOTIFICATION_ENGINE_ARCHITECTURE.md](../../core/engines/NOTIFICATION_ENGINE_ARCHITECTURE.md) |
| Workflow Engine | [WORKFLOW_ENGINE_ARCHITECTURE.md](../../core/engines/WORKFLOW_ENGINE_ARCHITECTURE.md) |
| Event Architecture | [EVENT_ARCHITECTURE.md](../../core/engines/EVENT_ARCHITECTURE.md) |
| Activity & Chatter | [ACTIVITY_CHATTER_ARCHITECTURE.md](../core/ACTIVITY_CHATTER_ARCHITECTURE.md) |

### AI platform

| Document | Link |
|----------|------|
| AI OS Architecture | [AI_OS_ARCHITECTURE.md](../ai/AI_OS_ARCHITECTURE.md) |
| AI Context Engine | [AI_CONTEXT_ENGINE.md](../ai/AI_CONTEXT_ENGINE.md) |
| AI Audit & Approval | [AI_AUDIT_AND_APPROVAL.md](../ai/AI_AUDIT_AND_APPROVAL.md) |

### UI / UX standards

| Document | Link |
|----------|------|
| UI/UX design standards | [UI_UX_DESIGN_STANDARDS.md](../../ui-ux/UI_UX_DESIGN_STANDARDS.md) |
| Enterprise UI architecture | [ENTERPRISE_UI_ARCHITECTURE.md](../../ui-ux/ENTERPRISE_UI_ARCHITECTURE.md) |
| Layout architecture | [layout-architecture.md](../../ui-ux/layout-architecture.md) |
| Navigation | [navigation.md](../../ui-ux/navigation.md) |
| Design system | [design-system.md](../../ui-ux/design-system.md) |
| Dashboard widgets | [dashboard-widgets.md](../../ui-ux/dashboard-widgets.md) |
| AI assistant UI | [ai-assistant-ui.md](../../ui-ux/ai-assistant-ui.md) |
| Mobile-first | [mobile-first.md](../../ui-ux/mobile-first.md) |
| Activity system | [activity-system.md](../../ui-ux/activity-system.md) |
| Reports UI | [reports-ui.md](../../ui-ux/reports-ui.md) |
...
9. **Documentation-first** — update arch docs before code per [GOVERNANCE.md](../../GOVERNANCE.md)
