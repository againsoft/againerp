...
> **Parent:** [HR_FIGMA_SCREEN_MAP.md](./HR_FIGMA_SCREEN_MAP.md) · [HR_FIGMA_WIREFRAME_BLUEPRINT.md](../HR_FIGMA_WIREFRAME_BLUEPRINT.md) · [HR_DESIGN_SYSTEM_SPECIFICATION.md](../../../design-system/HR_DESIGN_SYSTEM_SPECIFICATION.md)  
...
**Estimated duration:** 3–4 design sprints  
**Dependencies:** Phase 1–3 surfaces (context adapters) · [HR_AI_ASSISTANT_UI_ARCHITECTURE.md](./HR_AI_ASSISTANT_UI_ARCHITECTURE.md) · [AI_OS_ARCHITECTURE.md](../../../ai/AI_OS_ARCHITECTURE.md)
...
| [HR_DESIGN_SYSTEM_SPECIFICATION.md](../../../design-system/HR_DESIGN_SYSTEM_SPECIFICATION.md) | Component handoff |
