...
**Related:** [INVENTORY_MODULE_ARCHITECTURE.md](./INVENTORY_MODULE_ARCHITECTURE.md) · [INVENTORY_WORKFLOW.md](./INVENTORY_WORKFLOW.md) · [ENTITY_CATALOG.md](../ecommerce/catalog/ENTITY_CATALOG.md) · [ENTITY_RELATIONSHIP_REGISTRY.md](../../ENTITY_RELATIONSHIP_REGISTRY.md) · [DATABASE_REGISTRY.md](../../DATABASE_REGISTRY.md) · [TRACEABILITY_MATRIX.md](../../TRACEABILITY_MATRIX.md)
...
| Physical tables | [DATABASE_REGISTRY.md](../../DATABASE_REGISTRY.md) §5.2 |
...
> **Registry note:** [DATABASE_REGISTRY.md](../../DATABASE_REGISTRY.md) uses **Stock Level** as the compact name for **Stock Ledger** balance records. Same business entity.
...
**Alias:** Stock Level in [DATABASE_REGISTRY.md](../../DATABASE_REGISTRY.md) §5.2.
