...
> **UI:** [ai-assistant-ui.md](../../ui-ux/ai-assistant-ui.md) · [UX_SMART_INTERACTION_STANDARDS.md](../../ui-ux/UX_SMART_INTERACTION_STANDARDS.md)  
...
Uses Core [Approval Engine](../../core/engines/APPROVAL_ENGINE_ARCHITECTURE.md) — AI does not implement custom approval logic.
...
Prefix: `ai_*` — see [MASTER_DATABASE_ARCHITECTURE.md](../../database/MASTER_DATABASE_ARCHITECTURE.md) §25.
...
| [ai-assistant-ui.md](../../ui-ux/ai-assistant-ui.md) | UI surfaces |
| [future-interactions.md](../../ui-ux/future-interactions.md) | Copilot, voice hooks |
