...
> **Canonical:** [UI_PROTOTYPE_MODE.md](../UI_PROTOTYPE_MODE.md)  
> **Strategy:** [UI_PROTOTYPE_STRATEGY.md](../UI_PROTOTYPE_STRATEGY.md)
...
Cross-reference: [MENU_STRUCTURE.md](../modules/ecommerce/MENU_STRUCTURE.md) (167 menus)
