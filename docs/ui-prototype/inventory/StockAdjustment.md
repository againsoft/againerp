...
> **Menu Location:** Ecommerce → Inventory → Stock Adjustment  
> **Menu Doc:** [Menus mirror](../../modules/ecommerce/Menus/Inventory/Stock Adjustment.md)  
...
_TBD — prototype specification for Stock Adjustment._
...
`Ecommerce → Inventory → Stock Adjustment`

## Breadcrumb

`AgainERP › Ecommerce › Inventory › Stock Adjustment`
