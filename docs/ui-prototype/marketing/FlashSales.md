...
> **Menu Location:** Ecommerce → Marketing → Flash Sales  
> **Menu Doc:** [Menus mirror](../../modules/ecommerce/Menus/Marketing/Flash Sales.md)  
...
_TBD — prototype specification for Flash Sales._
...
`Ecommerce → Marketing → Flash Sales`

## Breadcrumb

`AgainERP › Ecommerce › Marketing › Flash Sales`
