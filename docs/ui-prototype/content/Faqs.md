...
> **Menu Location:** Ecommerce → Content → FAQs  
> **Menu Doc:** [Menus mirror](../../modules/ecommerce/Menus/Content/FAQs.md)  
...
_TBD — prototype specification for FAQs._
...
`Ecommerce → Content → FAQs`

## Breadcrumb

`AgainERP › Ecommerce › Content › FAQs`
