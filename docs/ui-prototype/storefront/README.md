...
| [../modules/ecommerce/ECOMMERCE_STOREFRONT_ARCHITECTURE.md](../../modules/ecommerce/ECOMMERCE_STOREFRONT_ARCHITECTURE.md) | Target production architecture (API-first) |
