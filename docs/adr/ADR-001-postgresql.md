...
- Aligns with [database/MASTER_DATABASE_ARCHITECTURE.md](../database/MASTER_DATABASE_ARCHITECTURE.md)
...
- [database/MASTER_DATABASE_ARCHITECTURE.md](../database/MASTER_DATABASE_ARCHITECTURE.md)
