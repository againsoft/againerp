...
- [AI_KNOWLEDGE_INDEX.md](../AI_KNOWLEDGE_INDEX.md) as single AI entry
...
- [modules/ai/AI_OS_ARCHITECTURE.md](../modules/ai/AI_OS_ARCHITECTURE.md)
- [modules/ai/AI_FIRST_ARCHITECTURE.md](../modules/ai/AI_FIRST_ARCHITECTURE.md)
- [AI_KNOWLEDGE_INDEX.md](../AI_KNOWLEDGE_INDEX.md)
