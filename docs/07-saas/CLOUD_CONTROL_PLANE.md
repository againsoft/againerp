...
---
## Purpose
SaaS platform documentation: CLOUD_CONTROL_PLANE.
...
**UI prototype:** [ui-prototype/platform/](../04-uiux/prototype/07-saas/)
...
| AI credits | Metered per [modules/ai/AI_OS_ARCHITECTURE.md](../06-ai/platform/ai/AI_OS_ARCHITECTURE.md) |
| Usage limits | API rate, storage, seats |

Doc: [modules/subscription/ARCHITECTURE.md](../03-business-modules/subscription/ARCHITECTURE.md)
...
Doc: [modules/marketplace/ARCHITECTURE.md](../03-business-modules/marketplace/ARCHITECTURE.md)
