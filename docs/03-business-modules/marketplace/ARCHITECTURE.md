...
## Purpose
Marketplace module architecture — scope, features, data ownership, and integration boundaries.

## When To Read
Read this file only if working on Marketplace architecture, features, or module boundaries.
