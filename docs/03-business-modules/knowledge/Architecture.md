...
## Purpose
Knowledge module architecture — scope, features, data ownership, and integration boundaries.

## When To Read
Read this file only if working on Knowledge architecture, features, or module boundaries.
