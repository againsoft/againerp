...
## Purpose
Finance module architecture — scope, features, data ownership, and integration boundaries.

## When To Read
Read this file only if working on Finance architecture, features, or module boundaries.

## Related Files
- [Dependencies](../../01-architecture/MODULE_DEPENDENCY_MAP.md)

## Read Next
- [Architecture](FINANCE_MODULE_ARCHITECTURE.md)
...
> **Note:** Early draft docs used `accounting_*` prefix. Implementation aligns `finance_*` as the canonical Finance module namespace; see [MASTER_DATABASE_ARCHITECTURE.md](../../05-development/database/MASTER_DATABASE_ARCHITECTURE.md).
...
Integrates [Approval Engine](../../02-core-platform/engines/APPROVAL_ENGINE_ARCHITECTURE.md) for batch release.
...
Large claims route through [Approval Engine](../../02-core-platform/engines/APPROVAL_ENGINE_ARCHITECTURE.md).
...
Full DDL deferred to implementation. Aligns with [MASTER_DATABASE_ARCHITECTURE.md](../../05-development/database/MASTER_DATABASE_ARCHITECTURE.md).
...
| [APPROVAL_ENGINE_ARCHITECTURE.md](../../02-core-platform/engines/APPROVAL_ENGINE_ARCHITECTURE.md) | Approval gates |
| [WORKFLOW_ENGINE_ARCHITECTURE.md](../../02-core-platform/engines/WORKFLOW_ENGINE_ARCHITECTURE.md) | Document state machines |
| [ACTIVITY_CHATTER_ARCHITECTURE.md](../../02-core-platform/subsystems/ACTIVITY_CHATTER_ARCHITECTURE.md) | Timeline & chatter |
| [MASTER_DATABASE_ARCHITECTURE.md](../../05-development/database/MASTER_DATABASE_ARCHITECTURE.md) | Database conventions |
