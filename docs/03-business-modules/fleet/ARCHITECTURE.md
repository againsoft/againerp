...
## Purpose
Fleet module architecture — scope, features, data ownership, and integration boundaries.

## When To Read
Read this file only if working on Fleet architecture, features, or module boundaries.
