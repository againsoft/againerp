...
## Purpose
BI System module architecture — scope, features, data ownership, and integration boundaries.

## When To Read
Read this file only if working on BI System architecture, features, or module boundaries.
