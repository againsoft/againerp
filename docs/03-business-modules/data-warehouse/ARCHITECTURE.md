...
## Purpose
Data Warehouse module architecture — scope, features, data ownership, and integration boundaries.

## When To Read
Read this file only if working on Data Warehouse architecture, features, or module boundaries.
