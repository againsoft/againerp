...
## Purpose
Sales Marketing UI prototype build guide — step-by-step screens.

## When To Read
Read only if building Sales Marketing UI prototype screens in apps/web/.

## Related Files
- [Architecture](../../06-ai/platform/ai/Architecture.md)
- [Module UI standard](../../04-uiux/standards/module-ui-standard.md)

## Read Next
- [Screen specs](../../04-uiux/prototype/sales-marketing/)

---

> **Status:** Active playbook  
> **Scope:** UI prototype — mock data, optional `/api/v1/sales-marketing/` routes  
> **Parent:** [ui-design/README.md](./ui-design/README.md) · [PROJECT_COMMON_RULES.md](../../00-foundation/PROJECT_COMMON_RULES.md)
