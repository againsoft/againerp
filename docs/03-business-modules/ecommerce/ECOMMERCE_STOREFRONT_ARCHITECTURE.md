...
## Purpose
Documentation: ECOMMERCE STOREFRONT ARCHITECTURE.

## When To Read
Read only if your task involves ecommerce storefront architecture.
...
> **Prototype (2026-06-13):** Next.js `(storefront)` route group implements **AgainShop** at `/shop/*` with mock data. As-built: [ui-prototype/storefront/IMPLEMENTED_DESIGN.md](../../04-uiux/prototype/storefront/IMPLEMENTED_DESIGN.md). Production migrates to `/api/v1/storefront/*` per §20.
...
**Related:** [catalog/ARCHITECTURE.md](./catalog/ARCHITECTURE.md) · [orders/ARCHITECTURE.md](./orders/ARCHITECTURE.md) · [builder/ARCHITECTURE.md](./builder/ARCHITECTURE.md) · [customers/ARCHITECTURE.md](./customers/ARCHITECTURE.md) · [seo/ARCHITECTURE.md](./seo/ARCHITECTURE.md) · [GLOBAL_SEARCH_ARCHITECTURE.md](../../02-core-platform/engines/GLOBAL_SEARCH_ARCHITECTURE.md) · [ENTITY_CATALOG.md](./catalog/ENTITY_CATALOG.md)
...
**Docs:** [plugins/bank-emi/Architecture.md](../../09-integrations/plugins/bank-emi/Architecture.md) · [ui-prototype/plugins/BankEmi.md](../../04-uiux/prototype/plugins/BankEmi.md)
...
Full as-built spec: [ui-prototype/storefront/IMPLEMENTED_DESIGN.md](../../04-uiux/prototype/storefront/IMPLEMENTED_DESIGN.md)
