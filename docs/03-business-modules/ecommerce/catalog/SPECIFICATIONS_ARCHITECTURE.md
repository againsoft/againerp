...
**Related:** [ARCHITECTURE.md](./ARCHITECTURE.md) · [AI_FIRST_ARCHITECTURE.md](../../../06-ai/platform/ai/AI_FIRST_ARCHITECTURE.md) · [MASTER_DATABASE_ARCHITECTURE.md](../../../05-development/database/MASTER_DATABASE_ARCHITECTURE.md)
...
AI operates through the [AI Service Layer](../../../06-ai/platform/ai/ARCHITECTURE.md) — never writes to published data without audit.
...
Prefix: `catalog_`. Mandatory audit columns per [database standards](../../../05-development/database/standards.md).
...
See [MASTER_DATABASE_ARCHITECTURE.md](../../../05-development/database/MASTER_DATABASE_ARCHITECTURE.md) for full column definitions.
...
|--------|-----|------|--------|
| Profiles list | [SpecificationsProfiles.md](../../../04-uiux/prototype/catalog/products/SpecificationsProfiles.md) | `attribute-profile-grid.tsx` | Built |
...
| Product spec editor | [EditProduct.md](../../../04-uiux/prototype/catalog/products/EditProduct.md) | — | Planned |
