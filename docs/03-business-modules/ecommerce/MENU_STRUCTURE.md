...
│
├── Customers (9)
│   ├── Customers                 → Core [contacts](../../02-core-platform/entities/contacts.md)
│   ├── Customer Groups
│   ├── Customer Wallet
│   ├── Reward Points
│   ├── Wishlists
│   ├── Saved Carts
│   ├── Customer Activities       → Core [activities](../../02-core-platform/entities/activities.md)
│   ├── Customer Support Tickets
│   └── Customer Addresses        → Core [addresses](../../02-core-platform/entities/addresses.md)
│
├── Marketing (16)
│   ├── Coupons
│   ├── Vouchers
...
│
├── Media (9)
│   ├── Media Library             → Core [media-library](../../02-core-platform/entities/media-library.md)
│   ├── Images
│   ├── Videos
│   ├── Documents
│   ├── Folders
...
└── System (24)
    ├── General Settings
    ├── Store Settings
    ├── Company Settings          → Core [companies](../../02-core-platform/entities/companies.md)
    ├── Branch Settings           → Core [branches](../../02-core-platform/entities/branches.md)
    ├── Localization
    ├── Languages
    ├── Currencies
    ├── Taxes
    ...
    ├── Shipping Methods
    ├── Shipping Zones
    ├── User Management           → Core [users](../../02-core-platform/entities/users.md)
    ├── Roles                     → Core [roles](../../02-core-platform/entities/roles.md)
    ├── Permissions               → Core [permissions](../../02-core-platform/entities/permissions.md)
    ├── Activity Logs
    ├── Audit Logs
    ├── API Management
    ├── Backup Manager
