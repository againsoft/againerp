...
> **Related:** [../hr/Architecture.md](../hr/Architecture.md) · [../payroll/Architecture.md](../payroll/Architecture.md) · [MASTER_MODULE_ARCHITECTURE.md](../../01-architecture/MASTER_MODULE_ARCHITECTURE.md) · [UNIVERSAL_MODULE_FRAMEWORK.md](../../00-foundation/UNIVERSAL_MODULE_FRAMEWORK.md) · [AI_OS_ARCHITECTURE.md](../../06-ai/platform/ai/AI_OS_ARCHITECTURE.md) · [ACTIVITY_CHATTER_ARCHITECTURE.md](../../02-core-platform/subsystems/ACTIVITY_CHATTER_ARCHITECTURE.md) · [database/multi-company.md](../../05-development/database/multi-company.md)
...
| 12 | **Drawer CRUD (UI)** | List + right Sheet drawer — no `/new` routes ([PROJECT_COMMON_RULES.md](../../00-foundation/PROJECT_COMMON_RULES.md)) |
...
Aligns with [database/multi-company.md](../../05-development/database/multi-company.md) and [SAAS_PLATFORM_ARCHITECTURE.md](../../01-architecture/SAAS_PLATFORM_ARCHITECTURE.md).
...
7. Retention policy on PII ([contacts](../../02-core-platform/entities/contacts.md))

---

## 12. Complete Module Structure

Production navigation map (drawer CRUD for entities — [PROJECT_COMMON_RULES.md](../../00-foundation/PROJECT_COMMON_RULES.md)).
...
Mobile-first mandatory ([PROJECT_COMMON_RULES.md](../../00-foundation/PROJECT_COMMON_RULES.md)).
...
Per [AI_OS_ARCHITECTURE.md](../../06-ai/platform/ai/AI_OS_ARCHITECTURE.md) — AI is a **platform service**, not an HR submodule.
...
Mandatory per [ACTIVITY_CHATTER_ARCHITECTURE.md](../../02-core-platform/subsystems/ACTIVITY_CHATTER_ARCHITECTURE.md).
...
Aligns with [core/PERMISSION_SYSTEM_ARCHITECTURE.md](../../02-core-platform/PERMISSION_SYSTEM_ARCHITECTURE.md).
...
**Pre-code gate:** Each child doc must reach **Ready** per [GOVERNANCE.md](../../00-foundation/GOVERNANCE.md) before implementation.
...
| [MASTER_MODULE_ARCHITECTURE.md](../../01-architecture/MASTER_MODULE_ARCHITECTURE.md) | Layer 3 ERP; HR → Payroll → Accounting chain |
