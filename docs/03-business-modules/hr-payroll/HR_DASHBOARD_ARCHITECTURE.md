...
> **Governance:** [dashboard-widgets.md](../../04-uiux/standards/dashboard-widgets.md) · [ENTERPRISE_UI_ARCHITECTURE.md](../../04-uiux/standards/ENTERPRISE_UI_ARCHITECTURE.md) · [HR_DATABASE_ARCHITECTURE.md](./HR_DATABASE_ARCHITECTURE.md) · [HR_ACTIVITY_LOG_ARCHITECTURE.md](./HR_ACTIVITY_LOG_ARCHITECTURE.md) · [HR_NOTIFICATION_ARCHITECTURE.md](./HR_NOTIFICATION_ARCHITECTURE.md) · [AI_OS_ARCHITECTURE.md](../../06-ai/platform/ai/AI_OS_ARCHITECTURE.md)
...
| **Platform widgets** | 12-column grid per [dashboard-widgets.md](../../04-uiux/standards/dashboard-widgets.md) |
...
Per [AI_OS_ARCHITECTURE.md](../../06-ai/platform/ai/AI_OS_ARCHITECTURE.md) — AI widgets are **read-only insights** with links to evidence.
...
| [dashboard-widgets.md](../../04-uiux/standards/dashboard-widgets.md) | Grid system |
