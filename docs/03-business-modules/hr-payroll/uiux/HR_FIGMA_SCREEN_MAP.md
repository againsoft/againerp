...
> **Parent:** [HR_FIGMA_WIREFRAME_BLUEPRINT.md](../HR_FIGMA_WIREFRAME_BLUEPRINT.md) · [HR_SCREEN_INVENTORY.md](../HR_SCREEN_INVENTORY.md) · [../../design-system/HR_DESIGN_SYSTEM_SPECIFICATION.md](../../../04-uiux/design-system/HR_DESIGN_SYSTEM_SPECIFICATION.md)  
...
| **02** | Design System | `DS/*` components — [HR_DESIGN_SYSTEM_SPECIFICATION.md](../../../04-uiux/design-system/HR_DESIGN_SYSTEM_SPECIFICATION.md) |
...
|-------------|------------|
| Color / type / space tokens | [design-system.md](../../../04-uiux/standards/design-system.md) |
| Component specs | [HR_DESIGN_SYSTEM_SPECIFICATION.md](../../../04-uiux/design-system/HR_DESIGN_SYSTEM_SPECIFICATION.md) |
| Status badges | [status-system.md](../../../04-uiux/standards/status-system.md) |
...
| **Frontend** | Component mapping `DS/*` → `apps/web` · route table · query params | [HR_DESIGN_SYSTEM_SPECIFICATION.md](../../../04-uiux/design-system/HR_DESIGN_SYSTEM_SPECIFICATION.md) § Frontend Mapping |
...
| [HR_DESIGN_SYSTEM_SPECIFICATION.md](../../../04-uiux/design-system/HR_DESIGN_SYSTEM_SPECIFICATION.md) | DS components |
