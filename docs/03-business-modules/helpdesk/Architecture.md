...
## Purpose
Helpdesk module architecture — scope, features, data ownership, and integration boundaries.

## When To Read
Read this file only if working on Helpdesk architecture, features, or module boundaries.
...
Per [MASTER_DATABASE_ARCHITECTURE](../../05-development/database/MASTER_DATABASE_ARCHITECTURE.md): `helpdesk_tickets` → `contacts`.
