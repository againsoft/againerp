...
> **Status:** Draft  
> **Governance:** [GOVERNANCE.md](../GOVERNANCE.md) · [SETTINGS_ARCHITECTURE.md](../modules/core/SETTINGS_ARCHITECTURE.md)  
> **UI Prototype:** [ui-prototype/settings/Plugins.md](../ui-prototype/settings/Plugins.md)  
...
|-----------|------|----------|------|--------|
| `pathao` | Pathao Courier | Shipping | [Plugins.md](../ui-prototype/settings/Plugins.md) | Prototype UI |
| `steadfast` | Steadfast Courier | Shipping | [Plugins.md](../ui-prototype/settings/Plugins.md) | Prototype UI |
| `bkash` | bKash | Payment | [Plugins.md](../ui-prototype/settings/Plugins.md) | Prototype UI |
| `sslcommerz` | SSLCommerz | Payment | [Plugins.md](../ui-prototype/settings/Plugins.md) | Prototype UI |
| `whatsapp` | WhatsApp Business | Communication | [Plugins.md](../ui-prototype/settings/Plugins.md) | Prototype UI |
...
4. [ ] Entry in [Plugins.md](../ui-prototype/settings/Plugins.md) registry table
5. [ ] Storefront impact in [IMPLEMENTED_DESIGN.md](../ui-prototype/storefront/IMPLEMENTED_DESIGN.md) (if customer-facing)
