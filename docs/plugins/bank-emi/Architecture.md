...
- [SETTINGS_ARCHITECTURE.md](../../modules/core/SETTINGS_ARCHITECTURE.md)
- [ECOMMERCE_STOREFRONT_ARCHITECTURE.md](../../modules/ecommerce/ECOMMERCE_STOREFRONT_ARCHITECTURE.md)
- [ui-prototype/plugins/BankEmi.md](../../ui-prototype/plugins/BankEmi.md)
- [Plugins.md](../../ui-prototype/settings/Plugins.md)
