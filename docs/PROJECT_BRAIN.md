...
Implementation start:
  1. PROJECT_BRAIN.md          ← you are here
...
Every business table **must** follow [database/standards.md](./database/standards.md):
...
| **Prefix ownership** | One module owns prefix — see [DATABASE_REGISTRY.md](./DATABASE_REGISTRY.md) |
...
Detail: [UI_PROTOTYPE_MODE.md](./UI_PROTOTYPE_MODE.md)
...
| **60/20/10/10** | Layout formula — [ENTERPRISE_UI_ARCHITECTURE.md](./ui-ux/ENTERPRISE_UI_ARCHITECTURE.md) |

**Global UI docs:** [ui-ux/UI_UX_DESIGN_STANDARDS.md](./ui-ux/UI_UX_DESIGN_STANDARDS.md) · [ui-ux/UX_SMART_INTERACTION_STANDARDS.md](./ui-ux/UX_SMART_INTERACTION_STANDARDS.md)
...
Register in [API_REGISTRY.md](./API_REGISTRY.md) when adding real endpoints.
...
| Module list & deps | [MODULE_REGISTRY.md](./MODULE_REGISTRY.md) · [MODULE_DEPENDENCY_MAP.md](./MODULE_DEPENDENCY_MAP.md) |
| Database design | [DATABASE_REGISTRY.md](./DATABASE_REGISTRY.md) · [database/MASTER_DATABASE_ARCHITECTURE.md](./database/MASTER_DATABASE_ARCHITECTURE.md) |
| Entity design | [ENTITY_RELATIONSHIP_REGISTRY.md](./ENTITY_RELATIONSHIP_REGISTRY.md) |
| UI shell | [ui-ux/ENTERPRISE_UI_ARCHITECTURE.md](./ui-ux/ENTERPRISE_UI_ARCHITECTURE.md) |
| Prototype rules | [UI_PROTOTYPE_MODE.md](./UI_PROTOTYPE_MODE.md) |
| Module `{m}` work | `docs/modules/{m}/Architecture.md` + `docs/ui-prototype/{m}/*` |
| AI OS UX | [ai_os/README.md](./ai_os/README.md) |
| AI OS platform | [modules/ai/AI_OS_ARCHITECTURE.md](./modules/ai/AI_OS_ARCHITECTURE.md) |
| AI agent map | [AI_KNOWLEDGE_INDEX.md](./AI_KNOWLEDGE_INDEX.md) |
...
| [docs/UI_PROTOTYPE_MODE.md](./UI_PROTOTYPE_MODE.md) | Current phase rules | ✅ Ready |
...
| [docs/MASTER_MODULE_ARCHITECTURE.md](./MASTER_MODULE_ARCHITECTURE.md) | Module blueprint | ✅ Ready |
| [docs/MODULE_DEPENDENCY_MAP.md](./MODULE_DEPENDENCY_MAP.md) | Cross-module deps | ✅ Ready |
| [docs/UNIVERSAL_MODULE_FRAMEWORK.md](./UNIVERSAL_MODULE_FRAMEWORK.md) | Module framework | ✅ Ready |
| [docs/DATABASE_REGISTRY.md](./DATABASE_REGISTRY.md) | Table ownership | ✅ Ready |
| [docs/database/standards.md](./database/standards.md) | Column standards | ✅ Ready |

### 14.3 UI & design

| File | Role | Status |
|------|------|--------|
| [docs/ui-ux/ENTERPRISE_UI_ARCHITECTURE.md](./ui-ux/ENTERPRISE_UI_ARCHITECTURE.md) | Admin shell | ✅ Ready |
| [docs/ui-ux/UI_UX_DESIGN_STANDARDS.md](./ui-ux/UI_UX_DESIGN_STANDARDS.md) | Design standards | ✅ Ready |
| [docs/ui-ux/recharts-conventions.md](./ui-ux/recharts-conventions.md) | Chart formatters | ✅ Ready |
| [docs/ui-ux/mobile-first.md](./ui-ux/mobile-first.md) | Mobile rules | ✅ Ready |
...
| File | Role | Status |
|------|------|--------|
| [docs/ai_os/README.md](./ai_os/README.md) | AI UX entry | ✅ Ready |
| [docs/ai_os/01_AI_COMMERCE_OS_VISION.md](./ai_os/01_AI_COMMERCE_OS_VISION.md) | Vision | ✅ Ready |
| [docs/ai_os/02_AI_USER_EXPERIENCE.md](./ai_os/02_AI_USER_EXPERIENCE.md) | UX patterns | ✅ Ready |
| [docs/ai_os/03_AI_ADMIN_EXPERIENCE.md](./ai_os/03_AI_ADMIN_EXPERIENCE.md) | Admin AI UX | ✅ Ready |
| [docs/ai_os/04_AI_STOREFRONT_EXPERIENCE.md](./ai_os/04_AI_STOREFRONT_EXPERIENCE.md) | Storefront AI UX | ✅ Ready |
| [docs/modules/ai/AI_OS_ARCHITECTURE.md](./modules/ai/AI_OS_ARCHITECTURE.md) | Platform AI OS | ✅ Ready |
| [docs/AI_KNOWLEDGE_INDEX.md](./AI_KNOWLEDGE_INDEX.md) | AI agent map | ✅ Ready |
