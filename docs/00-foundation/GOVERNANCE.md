...
| [PAGE_REGISTRY.md](registries/PAGE_REGISTRY.md) | All pages |
| [DATABASE_REGISTRY.md](registries/DATABASE_REGISTRY.md) | Database assets |
| [API_REGISTRY.md](registries/API_REGISTRY.md) | API catalog |
| [WORKFLOW_REGISTRY.md](registries/WORKFLOW_REGISTRY.md) | Workflows |
| [AI_KNOWLEDGE_INDEX.md](registries/AI_KNOWLEDGE_INDEX.md) | AI knowledge graph |
| [CHANGELOG.md](./CHANGELOG.md) | Change history |
| [ADR_INDEX.md](traceability/ADR_INDEX.md) | Architecture decisions |
| [TRACEABILITY_MATRIX.md](traceability/TRACEABILITY_MATRIX.md) | **Traceability Matrix** — requirements → registries (v2.0) |
...
**Technology rule:** No stack change without updating [TECHNOLOGY_CONSTITUTION.md](./TECHNOLOGY_CONSTITUTION.md) and [ADR_INDEX.md](traceability/ADR_INDEX.md).
...
1. Be registered in [DOCUMENT_REGISTRY.md](registries/DOCUMENT_REGISTRY.md)
...
4. [AI_KNOWLEDGE_INDEX.md](registries/AI_KNOWLEDGE_INDEX.md)
...
Before implementing any change, complete a [Change Impact Analysis](templates/_CHANGE_IMPACT_TEMPLATE.md).
...
Generate an [Architecture Sync Report](templates/_ARCHITECTURE_SYNC_REPORT_TEMPLATE.md) that:
...
See [\_MODULE\_MANIFEST\_TEMPLATE.md](templates/_MODULE_MANIFEST_TEMPLATE.md).
...
Maintain [MODULE_DEPENDENCY_MAP.md](../01-architecture/MODULE_DEPENDENCY_MAP.md) at the platform level.
...
Before any commit, complete the [Pre-Commit Checklist](templates/_COMMIT_CHECKLIST.md).
...
| Document | Purpose |
|----------|---------|
| [DEVELOPMENT_STANDARDS.md](standards/DEVELOPMENT_STANDARDS.md) | Global dev standards (mobile, API, DB, security) |
| [PROJECT_COMMON_RULES.md](PROJECT_COMMON_RULES.md) | **Universal rules** — core vs optional modules, SaaS, drawers, mobile, doc updates |
| [DOCUMENTATION_STANDARD.md](standards/DOCUMENTATION_STANDARD.md) | Section templates and status labels |
| [FILE_NAMING_STANDARD.md](standards/FILE_NAMING_STANDARD.md) | Naming conventions |
| [MODULE_STRUCTURE.md](./MODULE_STRUCTURE.md) | Module folder layout |
| [CHANGELOG.md](./CHANGELOG.md) | Change history |
| [MODULE_DEPENDENCY_MAP.md](../01-architecture/MODULE_DEPENDENCY_MAP.md) | Cross-module dependencies (master) |
| [DependencyMap.md](../01-architecture/DependencyMap.md) | Dependency quick reference |
| [\_COMMIT_CHECKLIST.md](templates/_COMMIT_CHECKLIST.md) | Pre-commit validation |
| [\_CHANGE_IMPACT_TEMPLATE.md](templates/_CHANGE_IMPACT_TEMPLATE.md) | Impact analysis template |
| [\_ARCHITECTURE_SYNC_REPORT_TEMPLATE.md](templates/_ARCHITECTURE_SYNC_REPORT_TEMPLATE.md) | Drift report template |
