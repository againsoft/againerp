...
## Read Next
- [Module scope](../MODULE_REGISTRY.md)
...
| ADRs | [ADR_INDEX.md](traceability/ADR_INDEX.md) |
| Dev standards | [DEVELOPMENT_STANDARDS.md](standards/DEVELOPMENT_STANDARDS.md) |
...
| Core | [core/ARCHITECTURE.md](../02-core-platform/ARCHITECTURE.md) |
| Hybrid licensed ERP | [HYBRID_LICENSED_ERP_ARCHITECTURE.md](../01-architecture/HYBRID_LICENSED_ERP_ARCHITECTURE.md) |
| SaaS | [SAAS_PLATFORM_ARCHITECTURE.md](../01-architecture/SAAS_PLATFORM_ARCHITECTURE.md) |
...
| Review | Document |
|--------|----------|
| Master schema | [database/MASTER_DATABASE_ARCHITECTURE.md](../05-development/database/MASTER_DATABASE_ARCHITECTURE.md) |
| Service registry | [SERVICE_REGISTRY.md](registries/SERVICE_REGISTRY.md) |
| Entity registry | [ENTITY_RELATIONSHIP_REGISTRY.md](registries/ENTITY_RELATIONSHIP_REGISTRY.md) |
| ER diagram | [database/ER_DIAGRAM.md](../05-development/database/ER_DIAGRAM.md) |
| Standards | [database/standards.md](../05-development/database/standards.md) |
| Registry | [DATABASE_REGISTRY.md](registries/DATABASE_REGISTRY.md) |
...
| Review | Document |
|--------|----------|
| Global standards | [api/README.md](../05-development/api/README.md) · [api/architecture.md](../05-development/api/architecture.md) |
| Core API | [core/API.md](../02-core-platform/API.md) |
| Registry | [API_REGISTRY.md](registries/API_REGISTRY.md) — architecture & domain operations |
...
| Review | Document |
|--------|----------|
| Enterprise UI | [ui-ux/ENTERPRISE_UI_ARCHITECTURE.md](../04-uiux/standards/ENTERPRISE_UI_ARCHITECTURE.md) |
| Smart interactions | [ui-ux/UX_SMART_INTERACTION_STANDARDS.md](../04-uiux/standards/UX_SMART_INTERACTION_STANDARDS.md) |
| Design standards | [ui-ux/UI_UX_DESIGN_STANDARDS.md](../04-uiux/standards/UI_UX_DESIGN_STANDARDS.md) |
| Design system | [ui-ux/design-system.md](../04-uiux/standards/design-system.md) |
| UI prototype gate | [UI_PROTOTYPE_STRATEGY.md](../04-uiux/strategy/UI_PROTOTYPE_STRATEGY.md) |
...
| Review | Document |
|--------|----------|
| AI knowledge entry | [AI_KNOWLEDGE_INDEX.md](registries/AI_KNOWLEDGE_INDEX.md) |
| AI OS experience (vision & UX) | [ai_os/README.md](../06-ai/experience/README.md) |
| AI OS architecture | [modules/ai/AI_OS_ARCHITECTURE.md](../06-ai/platform/ai/AI_OS_ARCHITECTURE.md) |
| AI-first rules | [modules/ai/AI_FIRST_ARCHITECTURE.md](../06-ai/platform/ai/AI_FIRST_ARCHITECTURE.md) |
| Audit & approval | [modules/ai/AI_AUDIT_AND_APPROVAL.md](../06-ai/platform/ai/AI_AUDIT_AND_APPROVAL.md) |
| Context engine | [modules/ai/AI_CONTEXT_ENGINE.md](../06-ai/platform/ai/AI_CONTEXT_ENGINE.md) |
...
| [PAGE_REGISTRY.md](registries/PAGE_REGISTRY.md) | Page scope |
| [ModuleManifest.md](../03-business-modules/ecommerce/ModuleManifest.md) | Module index pattern |
| [Workflow.md](../03-business-modules/ecommerce/Workflow.md) | State machines |
| [Permissions.md](../03-business-modules/ecommerce/Permissions.md) | ACL keys |
| [_PRE_CODE_GATE_CHECKLIST.md](templates/_PRE_CODE_GATE_CHECKLIST.md) | Fillable gate form |
...
| 4 | Register in [DOCUMENT_REGISTRY.md](registries/DOCUMENT_REGISTRY.md) |
...
When work is **UI/UX prototype only** per [UI_PROTOTYPE_MODE.md](../04-uiux/strategy/UI_PROTOTYPE_MODE.md):
...
Backend production starts after [ui-prototype/PRODUCTION_READINESS.md](../04-uiux/prototype/PRODUCTION_READINESS.md).
...
1. Read [README.md](./README.md) → [MASTER_INDEX.md](./MASTER_INDEX.md) → [PROJECT_MAP.md](../PROJECT_MAP.md) → [AI_KNOWLEDGE_INDEX.md](registries/AI_KNOWLEDGE_INDEX.md)
...
1. Complete [_PRE_CODE_GATE_CHECKLIST.md](templates/_PRE_CODE_GATE_CHECKLIST.md)
...
5. Pre-commit: [_COMMIT_CHECKLIST.md](templates/_COMMIT_CHECKLIST.md)
