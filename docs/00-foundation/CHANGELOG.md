...
## When To Read
Read only if your task involves changelog.
...
| Field | Value |
|-------|-------|
| **Version** | `1.0.0-website-docs` |
| **Module** | Website |
| **Change Type** | Added |
| **Reason** | Complete Website module documentation package containing all 11 required files and 51 screen specs, separating standard corporate/company website functionality from ecommerce |
| **Impact** | New documentation package under `docs/03-business-modules/website/` containing README, Architecture, Database schema, API contracts, Workflow state machines, Permissions matrix, Admin UI map, AI tools registry, Reports catalog, CHANGELOG, and MENU_STRUCTURE. Module registered in MODULE_REGISTRY. |

**Docs:** `docs/03-business-modules/website/README.md` · `Architecture.md` · `ModuleManifest.md` · `Database.md` · `API.md` · `Workflow.md` · `Permissions.md` · `UI.md` · `AI.md` · `Reports.md` · `CHANGELOG.md` · `MENU_STRUCTURE.md` · `Menus/`
...
**Docs:** `docs/modules/business-partners/` · `docs/ui-prototype/business-partners/` · [MODULE_DEPENDENCY_MAP.md](../01-architecture/MODULE_DEPENDENCY_MAP.md)
