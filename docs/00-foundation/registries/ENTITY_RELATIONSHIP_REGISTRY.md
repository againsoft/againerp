...
## Purpose
Documentation: ENTITY RELATIONSHIP REGISTRY.

## When To Read
Read only if your task involves entity relationship registry.
...
**Related:** [DATABASE_REGISTRY.md](DATABASE_REGISTRY.md) (data ownership blueprint) · [ENTITY_CATALOG.md](../../03-business-modules/ecommerce/catalog/ENTITY_CATALOG.md) (catalog domain detail) · [ENTITY_INVENTORY.md](../../03-business-modules/inventory/ENTITY_INVENTORY.md) (inventory domain detail) · [ENTITY_PURCHASE.md](../../03-business-modules/purchase/ENTITY_PURCHASE.md) (purchase domain detail) · [ENTITY_SALES.md](../../03-business-modules/sales/ENTITY_SALES.md) (sales domain detail) · [database/ER_DIAGRAM.md](../../05-development/database/ER_DIAGRAM.md) (physical ER) · [MODULE_DEPENDENCY_MAP.md](../../01-architecture/MODULE_DEPENDENCY_MAP.md) · [core/shared-entities.md](../../02-core-platform/shared-entities.md)
...
| Lifecycle & capability matrix | Mermaid ER diagram (see [ER_DIAGRAM.md](../../05-development/database/ER_DIAGRAM.md)) |
...
**Note:** "Organization" = **Company** in implementation docs ([entities/companies.md](../../02-core-platform/entities/companies.md)).
...
**Deep dive:** [ACTIVITY_CHATTER_ARCHITECTURE.md](../../02-core-platform/subsystems/ACTIVITY_CHATTER_ARCHITECTURE.md)
...
7. **Permissions** — register keys in [PERMISSION_SYSTEM_ARCHITECTURE.md](../../02-core-platform/PERMISSION_SYSTEM_ARCHITECTURE.md)
8. **Events** — publish `{domain}.{entity}.{action}` per [EVENT_ARCHITECTURE.md](../../02-core-platform/engines/EVENT_ARCHITECTURE.md)
9. **Dependencies** — update [MODULE_DEPENDENCY_MAP.md](../../01-architecture/MODULE_DEPENDENCY_MAP.md)
...
Full registry: [PERMISSION_SYSTEM_ARCHITECTURE.md](../../02-core-platform/PERMISSION_SYSTEM_ARCHITECTURE.md)
...
| [database/ER_DIAGRAM.md](../../05-development/database/ER_DIAGRAM.md) | Physical ER diagrams |
| [SERVICE_REGISTRY.md](./SERVICE_REGISTRY.md) | Service layer contracts |
| [MODULE_DEPENDENCY_MAP.md](../../01-architecture/MODULE_DEPENDENCY_MAP.md) | Module integration |
| [core/shared-entities.md](../../02-core-platform/shared-entities.md) | Core entity index |
