...
## Purpose
Documentation: DOCUMENT REGISTRY.

## When To Read
Read only if your task involves document registry.
...
| DOC-UI-PROTOTYPE-MODE | [UI_PROTOTYPE_MODE.md](../../04-uiux/strategy/UI_PROTOTYPE_MODE.md) | **Active** | Platform |
...
| DOC-ADR-INDEX | [ADR_INDEX.md](../traceability/ADR_INDEX.md) | Active | Platform |
| DOC-TRACEABILITY-MATRIX | [TRACEABILITY_MATRIX.md](../traceability/TRACEABILITY_MATRIX.md) | Active | Platform |
| DOC-DOCUMENTATION-HEALTH-REPORT | [DOCUMENTATION_HEALTH_REPORT.md](../standards/DOCUMENTATION_HEALTH_REPORT.md) | Active | Platform |
...
| DOC-MASTER-MODULE-ARCHITECTURE | [MASTER_MODULE_ARCHITECTURE.md](../../01-architecture/MASTER_MODULE_ARCHITECTURE.md) | platform | Draft |
| DOC-UNIVERSAL-MODULE-FRAMEWORK | [UNIVERSAL_MODULE_FRAMEWORK.md](../UNIVERSAL_MODULE_FRAMEWORK.md) | platform | Draft |
| DOC-SAAS-PLATFORM-ARCHITECTURE | [SAAS_PLATFORM_ARCHITECTURE.md](../../01-architecture/SAAS_PLATFORM_ARCHITECTURE.md) | platform | Draft |
| DOC-GOVERNANCE | [GOVERNANCE.md](../GOVERNANCE.md) | platform | Active |
| DOC-DEVELOPMENT-STANDARDS | [DEVELOPMENT_STANDARDS.md](../standards/DEVELOPMENT_STANDARDS.md) | platform | Active |

### Core

| ID | Document | Status |
|----|----------|--------|
| DOC-CORE-ARCHITECTURE | [core/ARCHITECTURE.md](../../02-core-platform/ARCHITECTURE.md) | Draft |
| DOC-CORE-API | [core/API.md](../../02-core-platform/API.md) | Draft |
| DOC-CORE-ENGINES | [core/engines/README.md](../../02-core-platform/engines/README.md) | Draft |
| DOC-CORE-ENTITIES | [core/entities/README.md](../../02-core-platform/entities/README.md) | Draft |

### Database

| ID | Document | Status |
|----|----------|--------|
| DOC-DB-MASTER | [database/MASTER_DATABASE_ARCHITECTURE.md](../../05-development/database/MASTER_DATABASE_ARCHITECTURE.md) | Draft |
| DOC-DB-ER | [database/ER_DIAGRAM.md](../../05-development/database/ER_DIAGRAM.md) | Draft |
...
| ID | Document | Status |
|----|----------|--------|
| DOC-AI-OS-INDEX | [ai_os/README.md](../../06-ai/experience/README.md) | Vision |
| DOC-AI-OS-VISION | [ai_os/01_AI_COMMERCE_OS_VISION.md](../../06-ai/experience/01_AI_COMMERCE_OS_VISION.md) | Vision |
| DOC-AI-OS-UX | [ai_os/02_AI_USER_EXPERIENCE.md](../../06-ai/experience/02_AI_USER_EXPERIENCE.md) | Vision |
| DOC-AI-OS-ADMIN | [ai_os/03_AI_ADMIN_EXPERIENCE.md](../../06-ai/experience/03_AI_ADMIN_EXPERIENCE.md) | Vision |
| DOC-AI-OS-STOREFRONT | [ai_os/04_AI_STOREFRONT_EXPERIENCE.md](../../06-ai/experience/04_AI_STOREFRONT_EXPERIENCE.md) | Vision |
| DOC-AI-OS | [modules/ai/AI_OS_ARCHITECTURE.md](../../06-ai/platform/ai/AI_OS_ARCHITECTURE.md) | Draft |
| DOC-AI-FIRST | [modules/ai/AI_FIRST_ARCHITECTURE.md](../../06-ai/platform/ai/AI_FIRST_ARCHITECTURE.md) | Draft |

### Ecommerce (Active)

| ID | Document | Status |
|----|----------|--------|
| DOC-ECOMMERCE-ARCH | [modules/ecommerce/Architecture.md](../../03-business-modules/ecommerce/Architecture.md) | Draft |
| DOC-ECOMMERCE-MANIFEST | [modules/ecommerce/ModuleManifest.md](../../03-business-modules/ecommerce/ModuleManifest.md) | Draft |
| DOC-ECOMMERCE-MENU | [modules/ecommerce/MENU_STRUCTURE.md](../../03-business-modules/ecommerce/MENU_STRUCTURE.md) | Draft |
