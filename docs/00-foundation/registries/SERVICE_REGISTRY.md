...
## When To Read
Read only if your task involves service registry.
...
**Related:** [MODULE_DEPENDENCY_MAP.md](../../01-architecture/MODULE_DEPENDENCY_MAP.md) · [framework/COMMUNICATION_CONTRACTS.md](../../05-development/framework/COMMUNICATION_CONTRACTS.md) · [framework/CORE_SERVICES.md](../../05-development/framework/CORE_SERVICES.md) · [EVENT_ARCHITECTURE.md](../../02-core-platform/engines/EVENT_ARCHITECTURE.md) · [API_REGISTRY.md](./API_REGISTRY.md)
...
| Registry | Focus |
|----------|-------|
| [MODULE_DEPENDENCY_MAP.md](../../01-architecture/MODULE_DEPENDENCY_MAP.md) | Module-level integration |
...
**API base:** `/api/v1/core/activities/` · **Doc:** [ACTIVITY_CHATTER_ARCHITECTURE.md](../../02-core-platform/subsystems/ACTIVITY_CHATTER_ARCHITECTURE.md)
...
**API base:** `/api/v1/core/notifications/` · **Doc:** [NOTIFICATION_ENGINE_ARCHITECTURE.md](../../02-core-platform/engines/NOTIFICATION_ENGINE_ARCHITECTURE.md)
...
**API base:** `/api/v1/core/approvals/` · **Doc:** [APPROVAL_ENGINE_ARCHITECTURE.md](../../02-core-platform/engines/APPROVAL_ENGINE_ARCHITECTURE.md)
...
**API base:** `/api/v1/core/workflow/` · **Doc:** [WORKFLOW_ENGINE_ARCHITECTURE.md](../../02-core-platform/engines/WORKFLOW_ENGINE_ARCHITECTURE.md)
...
**API base:** `/api/v1/core/permissions/` · **Doc:** [PERMISSION_SYSTEM_ARCHITECTURE.md](../../02-core-platform/PERMISSION_SYSTEM_ARCHITECTURE.md)
...
**API base:** `/api/v1/core/search/` · **Doc:** [GLOBAL_SEARCH_ARCHITECTURE.md](../../02-core-platform/engines/GLOBAL_SEARCH_ARCHITECTURE.md)
...
**API base:** `/api/v1/core/media/` · **Doc:** [core/entities/media-library.md](../../02-core-platform/entities/media-library.md)
...
**API base:** `/api/v1/ai/os/` · **Doc:** [AI_OS_ARCHITECTURE.md](../../06-ai/platform/ai/AI_OS_ARCHITECTURE.md)
...
**API base:** `/api/v1/core/audit/` · **Doc:** [database/audit-trail.md](../../05-development/database/audit-trail.md)
...
**API base:** `/api/v1/core/settings/` · **Doc:** [SETTINGS_ARCHITECTURE.md](../../02-core-platform/subsystems/SETTINGS_ARCHITECTURE.md)
...
**API base:** internal · **Doc:** [EVENT_ARCHITECTURE.md](../../02-core-platform/engines/EVENT_ARCHITECTURE.md)
...
**API base:** `/api/v1/catalog/` · **Doc:** [PRODUCT_MASTER_ARCHITECTURE.md](../../02-core-platform/subsystems/PRODUCT_MASTER_ARCHITECTURE.md)
...
**API base:** `/api/v1/inventory/` · **Doc:** [INVENTORY_MODULE_ARCHITECTURE.md](../../03-business-modules/inventory/INVENTORY_MODULE_ARCHITECTURE.md)
...
**API base:** `/api/v1/purchase/` · **Doc:** [PURCHASE_MODULE_ARCHITECTURE.md](../../03-business-modules/purchase/PURCHASE_MODULE_ARCHITECTURE.md)
...
**API base:** `/api/v1/sales/` · **Doc:** [SALES_MODULE_ARCHITECTURE.md](../../03-business-modules/sales/SALES_MODULE_ARCHITECTURE.md)
...
**API base:** `/api/v1/crm/` · **Doc:** [CRM_MODULE_ARCHITECTURE.md](../../03-business-modules/crm/CRM_MODULE_ARCHITECTURE.md)
...
**API base:** `/api/v1/marketing/` · **Doc:** [MARKETING_MODULE_ARCHITECTURE.md](../../03-business-modules/marketing/MARKETING_MODULE_ARCHITECTURE.md)
...
**API base:** `/api/v1/finance/` · **Doc:** [FINANCE_MODULE_ARCHITECTURE.md](../../03-business-modules/finance/FINANCE_MODULE_ARCHITECTURE.md)
...
Full module map: [MODULE_DEPENDENCY_MAP.md](../../01-architecture/MODULE_DEPENDENCY_MAP.md)
...
These Core services support the platform but are accessed via Identity/Parties subsystems — documented in [framework/CORE_SERVICES.md](../../05-development/framework/CORE_SERVICES.md):
...
| Document | Role |
|----------|------|
| [MODULE_DEPENDENCY_MAP.md](../../01-architecture/MODULE_DEPENDENCY_MAP.md) | Module-level deps |
| [framework/COMMUNICATION_CONTRACTS.md](../../05-development/framework/COMMUNICATION_CONTRACTS.md) | Integration channels |
| [framework/CORE_SERVICES.md](../../05-development/framework/CORE_SERVICES.md) | Extended Core catalog |
| [EVENT_ARCHITECTURE.md](../../02-core-platform/engines/EVENT_ARCHITECTURE.md) | Event bus |
| [API_REGISTRY.md](./API_REGISTRY.md) | HTTP API architecture |
