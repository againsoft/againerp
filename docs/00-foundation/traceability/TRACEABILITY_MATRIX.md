...
## When To Read
Read only if your task involves traceability matrix.
...
**Related:** [PRD.md](../PRD.md) · [MASTER_INDEX.md](../MASTER_INDEX.md) · [PROJECT_MAP.md](../../PROJECT_MAP.md) · [PAGE_REGISTRY.md](../registries/PAGE_REGISTRY.md) · [MODULE_REGISTRY.md](../../MODULE_REGISTRY.md)
...
| [PAGE_REGISTRY.md](../registries/PAGE_REGISTRY.md) | Pages |
| [ENTITY_RELATIONSHIP_REGISTRY.md](../registries/ENTITY_RELATIONSHIP_REGISTRY.md) | Entities |
| [SERVICE_REGISTRY.md](../registries/SERVICE_REGISTRY.md) | Services |
| [API_REGISTRY.md](../registries/API_REGISTRY.md) | API groups & operations |
| [WORKFLOW_REGISTRY.md](../registries/WORKFLOW_REGISTRY.md) | Workflows |
| [PERMISSION_SYSTEM_ARCHITECTURE.md](../../02-core-platform/PERMISSION_SYSTEM_ARCHITECTURE.md) | Permissions |
| [AI_KNOWLEDGE_INDEX.md](../registries/AI_KNOWLEDGE_INDEX.md) | AI agents & tools |
...
| AI | [AI_KNOWLEDGE_INDEX.md](../registries/AI_KNOWLEDGE_INDEX.md) |
...
| **Related Pages** | Product List, Add/Edit Product, Categories, Brands, Attributes ([Menus/Catalog/](./03-business-modules/ecommerce/Menus/Catalog/)) |
...
| **Owner Module** | Catalog |
| **Related Pages** | Product Reviews ([Menus/Catalog/](./03-business-modules/ecommerce/Menus/Catalog/)) |
...
| **Related Pages** | Stock Management, Warehouses, Transfers, Adjustments ([Menus/Inventory/](./03-business-modules/ecommerce/Menus/Inventory/)) |
...
| **Owner Module** | Sales |
| **Related Pages** | Orders, Quotations, Invoices, Shipments, Returns ([Menus/Sales/](./03-business-modules/ecommerce/Menus/Sales/)) |
...
| **Related Pages** | Storefront public pages ([ECOMMERCE_STOREFRONT_ARCHITECTURE.md](../../03-business-modules/ecommerce/ECOMMERCE_STOREFRONT_ARCHITECTURE.md)); admin: Carts, Checkout ([Menus/Sales/](./03-business-modules/ecommerce/Menus/Sales/)) |
...
| **Related Pages** | Coupons, Campaigns, Loyalty ([Menus/Marketing/](./03-business-modules/ecommerce/Menus/Marketing/)) |
...
| **Owner Module** | Core |
| **Related Pages** | Users, Roles, Permissions ([Menus/System/](./03-business-modules/ecommerce/Menus/System/)) |
...
| **Related Pages** | Global search bar (all modules) · [ui-ux/global-search.md](../../04-uiux/standards/global-search.md) |
...
| **Related Pages** | Notifications, Templates ([ui-ux/notifications.md](../../04-uiux/standards/notifications.md)) |
...
| **Related Pages** | AI screens ([Menus/AI/](./03-business-modules/ecommerce/Menus/AI/)) |
...
| **Related Pages** | Overview, Analytics ([Menus/Dashboard/](./03-business-modules/ecommerce/Menus/Dashboard/)) |
...
|--------|--------------|------------------|----------|
| Catalog | REQ-CATALOG-001, 002 | [PRODUCT_MASTER_ARCHITECTURE.md](../../02-core-platform/subsystems/PRODUCT_MASTER_ARCHITECTURE.md) | core/ModuleManifest |
| Inventory | REQ-INVENTORY-001 | [INVENTORY_MODULE_ARCHITECTURE.md](../../03-business-modules/inventory/INVENTORY_MODULE_ARCHITECTURE.md) | inventory |
| Purchase | REQ-PURCHASE-001 | [PURCHASE_MODULE_ARCHITECTURE.md](../../03-business-modules/purchase/PURCHASE_MODULE_ARCHITECTURE.md) | purchase |
| Sales | REQ-SALES-001 | [SALES_MODULE_ARCHITECTURE.md](../../03-business-modules/sales/SALES_MODULE_ARCHITECTURE.md) | sales |
| CRM | REQ-CRM-001 | [CRM_MODULE_ARCHITECTURE.md](../../03-business-modules/crm/CRM_MODULE_ARCHITECTURE.md) | crm |
| Marketing | REQ-MARKETING-001 | [MARKETING_MODULE_ARCHITECTURE.md](../../03-business-modules/marketing/MARKETING_MODULE_ARCHITECTURE.md) | marketing |
| Finance | REQ-FINANCE-001 | [FINANCE_MODULE_ARCHITECTURE.md](../../03-business-modules/finance/FINANCE_MODULE_ARCHITECTURE.md) | finance |
| Ecommerce | REQ-ECOM-001, 002 | [modules/ecommerce/Architecture.md](../../03-business-modules/ecommerce/Architecture.md) | ecommerce |
| Core | REQ-PLATFORM-001–004 | [core/ARCHITECTURE.md](../../02-core-platform/ARCHITECTURE.md) | core |
| Platform | REQ-PLATFORM-005 | [SAAS_PLATFORM_ARCHITECTURE.md](../../01-architecture/SAAS_PLATFORM_ARCHITECTURE.md) | platform |
| AI OS | REQ-AI-001 | [AI_OS_ARCHITECTURE.md](../../06-ai/platform/ai/AI_OS_ARCHITECTURE.md) | ai |

**Dependency map:** [MODULE_DEPENDENCY_MAP.md](../../01-architecture/MODULE_DEPENDENCY_MAP.md)
...
|--------|--------------|--------------|----------|
| Product | Catalog | REQ-CATALOG-001 | [ENTITY_CATALOG.md](../../03-business-modules/ecommerce/catalog/ENTITY_CATALOG.md) · [ENTITY_RELATIONSHIP_REGISTRY.md](../registries/ENTITY_RELATIONSHIP_REGISTRY.md) |
| Product Variant | Catalog | REQ-CATALOG-001 | [ENTITY_CATALOG.md](../../03-business-modules/ecommerce/catalog/ENTITY_CATALOG.md) §4.2 |
| Category / Brand | Catalog | REQ-CATALOG-001 | [ENTITY_CATALOG.md](../../03-business-modules/ecommerce/catalog/ENTITY_CATALOG.md) §4.4–§4.5 |
| Warehouse / Stock | Inventory | REQ-INVENTORY-001 | [ENTITY_INVENTORY.md](../../03-business-modules/inventory/ENTITY_INVENTORY.md) · [ENTITY_RELATIONSHIP_REGISTRY.md](../registries/ENTITY_RELATIONSHIP_REGISTRY.md) |
| Purchase Order | Purchase | REQ-PURCHASE-001 | [ENTITY_PURCHASE.md](../../03-business-modules/purchase/ENTITY_PURCHASE.md) · [ENTITY_RELATIONSHIP_REGISTRY.md](../registries/ENTITY_RELATIONSHIP_REGISTRY.md) |
| Sales Order | Sales | REQ-SALES-001, REQ-ECOM-001 | [ENTITY_SALES.md](../../03-business-modules/sales/ENTITY_SALES.md) · [ENTITY_RELATIONSHIP_REGISTRY.md](../registries/ENTITY_RELATIONSHIP_REGISTRY.md) |
| Quotation / Invoice | Sales | REQ-SALES-001 | [ENTITY_SALES.md](../../03-business-modules/sales/ENTITY_SALES.md) §4.3 · §4.9 |
| Customer | Core Contact | REQ-CRM-001, REQ-SALES-001 | [ENTITY_SALES.md](../../03-business-modules/sales/ENTITY_SALES.md) §4.1 |
...
**Database ownership:** [DATABASE_REGISTRY.md](../registries/DATABASE_REGISTRY.md) §4–§5
...
**Full registry:** [SERVICE_REGISTRY.md](../registries/SERVICE_REGISTRY.md)
...
**Registry:** [WORKFLOW_REGISTRY.md](../registries/WORKFLOW_REGISTRY.md)
...
**Registry:** [AI_KNOWLEDGE_INDEX.md](../registries/AI_KNOWLEDGE_INDEX.md) §14
...
Use this matrix + [MODULE_DEPENDENCY_MAP.md](../../01-architecture/MODULE_DEPENDENCY_MAP.md) before any schema or API change.
...
- [ ] [PAGE_REGISTRY.md](../registries/PAGE_REGISTRY.md) — screens listed
- [ ] [ENTITY_RELATIONSHIP_REGISTRY.md](../registries/ENTITY_RELATIONSHIP_REGISTRY.md) — entities listed
- [ ] [SERVICE_REGISTRY.md](../registries/SERVICE_REGISTRY.md) — service methods listed
- [ ] [API_REGISTRY.md](../registries/API_REGISTRY.md) — operations listed
- [ ] [WORKFLOW_REGISTRY.md](../registries/WORKFLOW_REGISTRY.md) — workflow ID (if stateful)
- [ ] [PERMISSION_SYSTEM_ARCHITECTURE.md](../../02-core-platform/PERMISSION_SYSTEM_ARCHITECTURE.md) — keys listed
- [ ] [AI_KNOWLEDGE_INDEX.md](../registries/AI_KNOWLEDGE_INDEX.md) — agents/tools (if AI)
