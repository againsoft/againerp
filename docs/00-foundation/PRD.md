...
> **Vision:** [01-architecture/project.md](../01-architecture/project.md) → [PRD.md](./PRD.md)
...
- [Vision pointer](../01-architecture/project.md)

## Read Next
- [Structure map](../FINAL_ERP_STRUCTURE_MAP.md)
...
Phases 5–10 per [MASTER_DEVELOPMENT_SEQUENCE.md](../10-roadmap/MASTER_DEVELOPMENT_SEQUENCE.md): CRM, Sales, Purchase, Accounting, POS, HR, AI, Marketplace, Enterprise, DevOps, Production.
...
| Document | Purpose |
|----------|---------|
| [MASTER_DEVELOPMENT_SEQUENCE.md](../10-roadmap/MASTER_DEVELOPMENT_SEQUENCE.md) | 100-step roadmap |
| [MASTER_MODULE_ARCHITECTURE.md](../01-architecture/MASTER_MODULE_ARCHITECTURE.md) | Platform layers |
| [MASTER_DATABASE_ARCHITECTURE.md](../05-development/database/MASTER_DATABASE_ARCHITECTURE.md) | Database blueprint |
| [GOVERNANCE.md](GOVERNANCE.md) | Doc-first workflow |
| [modules/ecommerce/MENU_STRUCTURE.md](../03-business-modules/ecommerce/MENU_STRUCTURE.md) | 167 screens |
