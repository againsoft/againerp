...
> Governance: [GOVERNANCE.md](../GOVERNANCE.md) · Standards: [DEVELOPMENT_STANDARDS.md](DEVELOPMENT_STANDARDS.md) · Pre-commit: [_COMMIT_CHECKLIST.md](../templates/_COMMIT_CHECKLIST.md)

## Purpose
Documentation: DOCUMENTATION STANDARD.

## When To Read
Read only if your task involves documentation standard.
...
- Link to related menu docs: `[Product List](../../03-business-modules/ecommerce/Menus/Catalog/Products/Product List.md)`
- Link to module docs: `[Ecommerce Database](../../03-business-modules/ecommerce/Database.md)`
- Link to core docs: `[Permission System](../../02-core-platform/entities/permissions.md)`
