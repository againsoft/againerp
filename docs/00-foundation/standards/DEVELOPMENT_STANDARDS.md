...
## When To Read
Read only if your task involves development standards.
...
**Detail:** [ui-ux/mobile-first.md](../../04-uiux/standards/mobile-first.md) · **Enterprise UI:** [ui-ux/ENTERPRISE_UI_ARCHITECTURE.md](../../04-uiux/standards/ENTERPRISE_UI_ARCHITECTURE.md) · **Smart UX:** [ui-ux/UX_SMART_INTERACTION_STANDARDS.md](../../04-uiux/standards/UX_SMART_INTERACTION_STANDARDS.md)
...
**Detail:** [ui-ux/seo.md](../../04-uiux/standards/seo.md)
...
See [MODULE_DEPENDENCY_MAP.md](../../01-architecture/MODULE_DEPENDENCY_MAP.md) and [SERVICE_REGISTRY.md](../registries/SERVICE_REGISTRY.md).
...
Additional module-specific columns follow naming conventions in [database/naming-conventions.md](../../05-development/database/naming-conventions.md).

**Detail:** [database/standards.md](../../05-development/database/standards.md)
...
**Detail:** [deployment/monitoring.md](../../05-development/deployment/monitoring.md)
