...
_Describe sections, tabs, sidebar, table columns, filters, and empty states. Follow [ui-ux/ENTERPRISE_UI_ARCHITECTURE.md](../ui-ux/ENTERPRISE_UI_ARCHITECTURE.md)._
...
**Record view:** Include tabs + Chatter panel per [ui-ux/record-view.md](../ui-ux/record-view.md). Document mobile behavior per [ui-ux/mobile-first.md](../ui-ux/mobile-first.md).
