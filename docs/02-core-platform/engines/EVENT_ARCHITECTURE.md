...
## Purpose
Core engine specification: EVENT ARCHITECTURE.

## When To Read
Read only when working on the EVENT ARCHITECTURE engine or its consumers.
...
**Related:** [adr/ADR-006-event-driven.md](../../01-architecture/decisions/ADR-006-event-driven.md) · [WORKFLOW_ENGINE_ARCHITECTURE.md](./WORKFLOW_ENGINE_ARCHITECTURE.md) · [DATABASE_REGISTRY.md](../../00-foundation/registries/DATABASE_REGISTRY.md) · [AI_OS_ARCHITECTURE.md](../../06-ai/platform/ai/AI_OS_ARCHITECTURE.md) · [framework/COMMUNICATION_CONTRACTS.md](../../05-development/framework/COMMUNICATION_CONTRACTS.md) · [event-system.md](./event-system.md) (legacy draft)
...
**ADR:** [ADR-006-event-driven.md](../../01-architecture/decisions/ADR-006-event-driven.md)
...
| Workflow transitions emit domain events | Per [WORKFLOW_REGISTRY.md](../../00-foundation/registries/WORKFLOW_REGISTRY.md) |
...
Full workflow transition mapping: [WORKFLOW_REGISTRY.md § Event Mapping](../../00-foundation/registries/WORKFLOW_REGISTRY.md)
...
| [WORKFLOW_REGISTRY.md](../../00-foundation/registries/WORKFLOW_REGISTRY.md) | Event mapping |
| [DATABASE_REGISTRY.md](../../00-foundation/registries/DATABASE_REGISTRY.md) | Aggregate ownership |
| [AI_OS_ARCHITECTURE.md](../../06-ai/platform/ai/AI_OS_ARCHITECTURE.md) | AI consumers |
| [GLOBAL_SEARCH_ARCHITECTURE.md](./GLOBAL_SEARCH_ARCHITECTURE.md) | Search index consumers |
| [framework/COMMUNICATION_CONTRACTS.md](../../05-development/framework/COMMUNICATION_CONTRACTS.md) | Module communication |
