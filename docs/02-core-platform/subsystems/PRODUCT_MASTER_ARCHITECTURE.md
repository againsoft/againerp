...
## Purpose
Core subsystem architecture: PRODUCT MASTER ARCHITECTURE.

## When To Read
Read only when working on PRODUCT MASTER ARCHITECTURE or modules that consume it.
...
**Related:** [ACTIVITY_CHATTER_ARCHITECTURE.md](./ACTIVITY_CHATTER_ARCHITECTURE.md) · [CRM_MODULE_ARCHITECTURE.md](../../03-business-modules/crm/CRM_MODULE_ARCHITECTURE.md) · [modules/sales/SALES_MODULE_ARCHITECTURE.md](../../03-business-modules/sales/SALES_MODULE_ARCHITECTURE.md) · [modules/inventory/INVENTORY_MODULE_ARCHITECTURE.md](../../03-business-modules/inventory/INVENTORY_MODULE_ARCHITECTURE.md) · [modules/purchase/PURCHASE_MODULE_ARCHITECTURE.md](../../03-business-modules/purchase/PURCHASE_MODULE_ARCHITECTURE.md) · [modules/ecommerce/catalog/ARCHITECTURE.md](../../03-business-modules/ecommerce/catalog/ARCHITECTURE.md) · [modules/ecommerce/catalog/SPECIFICATIONS_ARCHITECTURE.md](../../03-business-modules/ecommerce/catalog/SPECIFICATIONS_ARCHITECTURE.md) · [core/entities/activities.md](../../02-core-platform/entities/activities.md) · [core/engines/WORKFLOW_ENGINE_ARCHITECTURE.md](../../02-core-platform/engines/WORKFLOW_ENGINE_ARCHITECTURE.md)
...
Uses Core [Media Library](../../02-core-platform/entities/media-library.md) and [Attachments](../../02-core-platform/entities/attachments.md).
...
**Full specification:** [SPECIFICATIONS_ARCHITECTURE.md](../../03-business-modules/ecommerce/catalog/SPECIFICATIONS_ARCHITECTURE.md)
...
Product lifecycle integrates [Approval Engine](../../02-core-platform/engines/APPROVAL_ENGINE_ARCHITECTURE.md) and [Workflow Engine](../../02-core-platform/engines/WORKFLOW_ENGINE_ARCHITECTURE.md). **Approval Workflow Integration** is mandatory — no product reaches `published` without policy compliance.
...
Permissions follow `Product.{Action}` namespace. Registered in Core [Permissions](../../02-core-platform/entities/permissions.md).
...
**Phase:** UI/UX Planning · Prototype reference: [ui-prototype/catalog/products/](../../04-uiux/prototype/catalog/products/)
...
**Engine:** [Global Search Architecture](../../02-core-platform/engines/GLOBAL_SEARCH_ARCHITECTURE.md) — Meilisearch indexing, permission-filtered results.
...
| 15 | **Documentation Before Code** — [PRE_CODE_GATE.md](../../00-foundation/PRE_CODE_GATE.md) |
...
|----------|--------------|
| [modules/inventory/INVENTORY_MODULE_ARCHITECTURE.md](../../03-business-modules/inventory/INVENTORY_MODULE_ARCHITECTURE.md) | Inventory module — stock ledger |
| [modules/purchase/PURCHASE_MODULE_ARCHITECTURE.md](../../03-business-modules/purchase/PURCHASE_MODULE_ARCHITECTURE.md) | Purchase module — procure-to-pay |
| [modules/sales/SALES_MODULE_ARCHITECTURE.md](../../03-business-modules/sales/SALES_MODULE_ARCHITECTURE.md) | Sales module — quote-to-cash |
| [CRM_MODULE_ARCHITECTURE.md](../../03-business-modules/crm/CRM_MODULE_ARCHITECTURE.md) | CRM — pipeline, customer intelligence |
| [modules/ecommerce/catalog/ARCHITECTURE.md](../../03-business-modules/ecommerce/catalog/ARCHITECTURE.md) | Ecommerce Catalog module — primary Product UI |
| [modules/ecommerce/catalog/SPECIFICATIONS_ARCHITECTURE.md](../../03-business-modules/ecommerce/catalog/SPECIFICATIONS_ARCHITECTURE.md) | Specification profiles detail |
...
| [core/engines/WORKFLOW_ENGINE_ARCHITECTURE.md](../../02-core-platform/engines/WORKFLOW_ENGINE_ARCHITECTURE.md) | Lifecycle workflows |
| [core/engines/APPROVAL_ENGINE_ARCHITECTURE.md](../../02-core-platform/engines/APPROVAL_ENGINE_ARCHITECTURE.md) | Approval policies |
| [core/engines/GLOBAL_SEARCH_ARCHITECTURE.md](../../02-core-platform/engines/GLOBAL_SEARCH_ARCHITECTURE.md) | Global search indexing |
| [modules/ai/AI_OS_ARCHITECTURE.md](../../06-ai/platform/ai/AI_OS_ARCHITECTURE.md) | AI agent platform |
| [ui-prototype/catalog/products/ProductList.md](../../04-uiux/prototype/catalog/products/ProductList.md) | List UI prototype |
| [ui-prototype/catalog/products/AddProduct.md](../../04-uiux/prototype/catalog/products/AddProduct.md) | Create UI prototype |
