...
## Purpose
Core entity specification: `media-library`.

## When To Read
Read only when working on the shared `media-library` entity — not module-owned duplicates.
...
- See [DEVELOPMENT_STANDARDS.md §12](../../00-foundation/standards/DEVELOPMENT_STANDARDS.md#12-file-management-standards)
