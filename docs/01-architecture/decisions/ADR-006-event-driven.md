...
- [framework/COMMUNICATION_CONTRACTS.md](../../05-development/framework/COMMUNICATION_CONTRACTS.md)
...
- [core/engines/EVENT_ARCHITECTURE.md](../../02-core-platform/engines/EVENT_ARCHITECTURE.md)
