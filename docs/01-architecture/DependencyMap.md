...
> See [GOVERNANCE.md](../00-foundation/GOVERNANCE.md#dependency-map-rule) · **Master:** [MODULE_DEPENDENCY_MAP.md](MODULE_DEPENDENCY_MAP.md) · **Platform:** [MASTER_MODULE_ARCHITECTURE.md](MASTER_MODULE_ARCHITECTURE.md)
...
## Related Files
- [Authoritative dependency map](MODULE_DEPENDENCY_MAP.md)

## Read Next
- [Use this instead](MODULE_DEPENDENCY_MAP.md)
