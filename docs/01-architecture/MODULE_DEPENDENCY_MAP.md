...
- [Module docs](../03-business-modules/)

## Read Next
- [Module architecture patterns](MASTER_MODULE_ARCHITECTURE.md)
...
**Related:** [DependencyMap.md](./DependencyMap.md) (summary) · [UNIVERSAL_MODULE_FRAMEWORK.md](../00-foundation/UNIVERSAL_MODULE_FRAMEWORK.md) · [framework/COMMUNICATION_CONTRACTS.md](../05-development/framework/COMMUNICATION_CONTRACTS.md) · [EVENT_ARCHITECTURE.md](../02-core-platform/engines/EVENT_ARCHITECTURE.md) · [DATABASE_REGISTRY.md](../00-foundation/registries/DATABASE_REGISTRY.md)
...
**Deep dive:** [PERMISSION_SYSTEM_ARCHITECTURE.md](../02-core-platform/PERMISSION_SYSTEM_ARCHITECTURE.md)
...
**Deep dive:** [WORKFLOW_ENGINE_ARCHITECTURE.md](../02-core-platform/engines/WORKFLOW_ENGINE_ARCHITECTURE.md)
...
**Deep dive:** [APPROVAL_ENGINE_ARCHITECTURE.md](../02-core-platform/engines/APPROVAL_ENGINE_ARCHITECTURE.md)
...
**Deep dive:** [NOTIFICATION_ENGINE_ARCHITECTURE.md](../02-core-platform/engines/NOTIFICATION_ENGINE_ARCHITECTURE.md)
...
**Deep dive:** [GLOBAL_SEARCH_ARCHITECTURE.md](../02-core-platform/engines/GLOBAL_SEARCH_ARCHITECTURE.md)
...
**Deep dive:** [modules/business-partners/Architecture.md](../03-business-modules/business-partners/Architecture.md) · [INTEGRATION.md](../03-business-modules/business-partners/INTEGRATION.md)
...
**Deep dive:** [MARKETING_MODULE_ARCHITECTURE.md](../03-business-modules/marketing/MARKETING_MODULE_ARCHITECTURE.md)
...
**Deep dive:** [FINANCE_MODULE_ARCHITECTURE.md](../03-business-modules/finance/FINANCE_MODULE_ARCHITECTURE.md)
...
**Deep dive:** [UNIVERSAL_MODULE_FRAMEWORK.md](../00-foundation/UNIVERSAL_MODULE_FRAMEWORK.md) · [MASTER_MODULE_ARCHITECTURE.md](MASTER_MODULE_ARCHITECTURE.md)
...
**Deep dive:** [AI_OS_ARCHITECTURE.md](../06-ai/platform/ai/AI_OS_ARCHITECTURE.md)
...
| 4 | **Single table owner** | One writer per entity ([DATABASE_REGISTRY.md](../00-foundation/registries/DATABASE_REGISTRY.md)) |
...
2. Register in [MODULE_REGISTRY.md](../MODULE_REGISTRY.md) and [DATABASE_REGISTRY.md](../00-foundation/registries/DATABASE_REGISTRY.md)
...
8. Update [CHANGELOG.md](../00-foundation/CHANGELOG.md)
...
1. Rare — requires ADR ([ADR_INDEX.md](../00-foundation/traceability/ADR_INDEX.md))
...
Full event catalog: [EVENT_ARCHITECTURE.md](../02-core-platform/engines/EVENT_ARCHITECTURE.md)
...
| [SERVICE_REGISTRY.md](../00-foundation/registries/SERVICE_REGISTRY.md) | Service contracts |
