...
|---------|----------|-----|
| **Identity** | Users, auth, sessions | [core/entities/users.md](./core/entities/users.md) |
| **RBAC** | Roles, permissions, ACL | [core/PERMISSION_SYSTEM_ARCHITECTURE.md](./core/PERMISSION_SYSTEM_ARCHITECTURE.md) |
| **Tenant** | Companies, branches | [core/entities/companies.md](./core/entities/companies.md) |
| **Parties** | Contacts, addresses | [core/entities/contacts.md](./core/entities/contacts.md) |
| **Collaboration** | Activities, comments, notes | [core/entities/activities.md](./core/entities/activities.md) |
| **Media** | Files, attachments | [core/entities/media-library.md](./core/entities/media-library.md) |
| **Workflow** | State machines | [core/engines/workflow-engine.md](./core/engines/workflow-engine.md) |
| **Approval** | Human approval chains | [core/engines/APPROVAL_ENGINE_ARCHITECTURE.md](./core/engines/APPROVAL_ENGINE_ARCHITECTURE.md) |
| **Events** | Event bus | [core/engines/EVENT_ARCHITECTURE.md](./core/engines/EVENT_ARCHITECTURE.md) |
| **Search** | Global + module search | [core/engines/GLOBAL_SEARCH_ARCHITECTURE.md](./core/engines/GLOBAL_SEARCH_ARCHITECTURE.md) |
| **API** | Keys, webhooks, rate limits | [core/API.md](./core/API.md) |
| **Audit** | Immutable logs | [database/audit-trail.md](./database/audit-trail.md) |
| **Settings** | Config hierarchy | [core/entities/settings.md](./core/entities/settings.md) |
| **i18n / Money** | Languages, currencies, taxes | [core/entities/localization.md](./core/entities/localization.md) |
| **Notifications** | Email, in-app, SMS, push, Slack | [core/engines/NOTIFICATION_ENGINE_ARCHITECTURE.md](./core/engines/NOTIFICATION_ENGINE_ARCHITECTURE.md) |
| **Queue / Cache** | Async jobs, Redis | [core/engines/queue-architecture.md](./core/engines/queue-architecture.md) |

**Detail:** [framework/CORE_SERVICES.md](./framework/CORE_SERVICES.md)
...
**Detail:** [framework/COMMUNICATION_CONTRACTS.md](./framework/COMMUNICATION_CONTRACTS.md)
...
**Global conventions:** [database/MASTER_DATABASE_ARCHITECTURE.md](./database/MASTER_DATABASE_ARCHITECTURE.md)
...
**Template:** [framework/templates/AI_TEMPLATE.md](./framework/templates/AI_TEMPLATE.md)  
**Platform:** [modules/ai/AI_OS_ARCHITECTURE.md](./modules/ai/AI_OS_ARCHITECTURE.md)
...
**Detail:** [framework/MODULE_LIFECYCLE.md](./framework/MODULE_LIFECYCLE.md)
...
Update [MODULE_DEPENDENCY_MAP.md](./MODULE_DEPENDENCY_MAP.md) on every new dependency.
...
9. [ ] Register in [roadmap/modules.md](./roadmap/modules.md)
10. [ ] Update [MODULE_DEPENDENCY_MAP.md](./MODULE_DEPENDENCY_MAP.md)
...
**Detail:** [framework/INDUSTRY_MODULES.md](./framework/INDUSTRY_MODULES.md)
...
| Document | Topic |
|----------|-------|
| [framework/CORE_SERVICES.md](./framework/CORE_SERVICES.md) | Core service catalog |
| [framework/COMMUNICATION_CONTRACTS.md](./framework/COMMUNICATION_CONTRACTS.md) | Services, events, APIs |
| [framework/MODULE_LIFECYCLE.md](./framework/MODULE_LIFECYCLE.md) | Install, upgrade, remove |
| [framework/INDUSTRY_MODULES.md](./framework/INDUSTRY_MODULES.md) | Vertical module catalog |
