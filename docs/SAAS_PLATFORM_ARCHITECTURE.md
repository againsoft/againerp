...
**Why:** Aligns with existing [multi-company.md](./database/multi-company.md) design — no schema rewrite. Single migration pipeline. Cost-efficient to 10k+ tenants.
...
Integrates: [AI_OS_ARCHITECTURE.md](./modules/ai/AI_OS_ARCHITECTURE.md) — check credits before Chief Agent invocation.
...
**Detail:** [platform/SCALING_ROADMAP.md](./platform/SCALING_ROADMAP.md) · [deployment/README.md](./deployment/README.md)
