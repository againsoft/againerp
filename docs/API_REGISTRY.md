...
**Related:** [SERVICE_REGISTRY.md](./SERVICE_REGISTRY.md) · [PERMISSION_SYSTEM_ARCHITECTURE.md](./core/PERMISSION_SYSTEM_ARCHITECTURE.md) · [api/architecture.md](./api/architecture.md) · [core/API.md](./core/API.md)
...
Integrates [PERMISSION_SYSTEM_ARCHITECTURE.md](./core/PERMISSION_SYSTEM_ARCHITECTURE.md).
...
Owned by Core Search — see [GLOBAL_SEARCH_ARCHITECTURE.md](./core/engines/GLOBAL_SEARCH_ARCHITECTURE.md).
...
| [api/architecture.md](./api/architecture.md) | API-first flow |
| [core/API.md](./core/API.md) | Core route reference (implementation) |
| [PERMISSION_SYSTEM_ARCHITECTURE.md](./core/PERMISSION_SYSTEM_ARCHITECTURE.md) | Authorization |
| [EVENT_ARCHITECTURE.md](./core/engines/EVENT_ARCHITECTURE.md) | Event names |
