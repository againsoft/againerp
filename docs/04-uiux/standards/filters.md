...
> **Standards:** [DEVELOPMENT_STANDARDS.md §13](../../00-foundation/standards/DEVELOPMENT_STANDARDS.md#13-search-standards) · [tables.md](./tables.md) · [forms.md](./forms.md)

## Purpose
Global UI standard: filters.

## When To Read
Read only if working on UI patterns related to filters.
...
- Fiscal year respects company settings ([DEVELOPMENT_STANDARDS.md §9](../../00-foundation/standards/DEVELOPMENT_STANDARDS.md#9-multi-company-ready))
