...
## Purpose
Global UI standard: ai assistant ui.

## When To Read
Read only if working on UI patterns related to ai assistant ui.
...
See [AI_FIRST_ARCHITECTURE.md](../../06-ai/platform/ai/AI_FIRST_ARCHITECTURE.md) § Universal Actions.
