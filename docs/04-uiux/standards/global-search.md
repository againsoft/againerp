...
> **Architecture:** [GLOBAL_SEARCH_ARCHITECTURE.md](../../02-core-platform/engines/GLOBAL_SEARCH_ARCHITECTURE.md) · [ENTERPRISE_UI_ARCHITECTURE.md](./ENTERPRISE_UI_ARCHITECTURE.md)  
> **Standards:** [DEVELOPMENT_STANDARDS.md §13](../../00-foundation/standards/DEVELOPMENT_STANDARDS.md#13-search-standards) · [navigation.md](./navigation.md)

## Purpose
Global UI standard: global search.

## When To Read
Read only if working on UI patterns related to global search.
...
**Placeholder:** "Search records, settings, actions…" — translatable per [DEVELOPMENT_STANDARDS.md §10](../../00-foundation/standards/DEVELOPMENT_STANDARDS.md#10-multi-language-ready).
...
Relevance scoring: exact match > prefix > fuzzy. v2 uses Meilisearch; see [GLOBAL_SEARCH_ARCHITECTURE.md §8](../../02-core-platform/engines/GLOBAL_SEARCH_ARCHITECTURE.md#8-search-ranking).
...
**Activity tracking:** Search queries logged per [DEVELOPMENT_STANDARDS.md §4](../../00-foundation/standards/DEVELOPMENT_STANDARDS.md#4-user-activity-tracking) (query text anonymizable in GDPR mode).
...
| Document | Topic |
|----------|-------|
| [GLOBAL_SEARCH_ARCHITECTURE.md](../../02-core-platform/engines/GLOBAL_SEARCH_ARCHITECTURE.md) | Platform search engine, index registry, AI |
