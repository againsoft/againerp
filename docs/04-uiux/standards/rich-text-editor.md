...
## Purpose
Global UI standard: rich text editor.

## When To Read
Read only if working on UI patterns related to rich text editor.
...
**Detail:** [EDITOR_AI_RULES.md](../prototype/catalog/products/EDITOR_AI_RULES.md) — two toolbar icons, Settings prompt mapping, apply + audit rules.
