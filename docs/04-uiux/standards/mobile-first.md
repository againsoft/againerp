...
> Parent: [DEVELOPMENT_STANDARDS.md §1](../../00-foundation/standards/DEVELOPMENT_STANDARDS.md#1-mobile-first-design)

## Purpose
Global UI standard: mobile first.

## When To Read
Read only if working on UI patterns related to mobile first.
