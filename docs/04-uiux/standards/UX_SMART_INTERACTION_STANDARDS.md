...
## Purpose
Global UI standard: UX_SMART_INTERACTION_STANDARDS.

## When To Read
Read only if working on UI patterns related to UX_SMART_INTERACTION_STANDARDS.
...
**Detail:** [ai-assistant-ui.md](./ai-assistant-ui.md) · [AI_FIRST_ARCHITECTURE.md](../../06-ai/platform/ai/AI_FIRST_ARCHITECTURE.md)
...
**Detail:** [modules/ecommerce/catalog/ARCHITECTURE.md](../../03-business-modules/ecommerce/catalog/ARCHITECTURE.md) · [forms.md](./forms.md)
