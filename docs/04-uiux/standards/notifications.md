...
> **Core:** [NOTIFICATION_ENGINE_ARCHITECTURE.md](../../02-core-platform/engines/NOTIFICATION_ENGINE_ARCHITECTURE.md) · [core/entities/notifications.md](../../02-core-platform/entities/notifications.md)

---

## Purpose
Global UI standard: notifications.

## When To Read
Read only if working on UI patterns related to notifications.
