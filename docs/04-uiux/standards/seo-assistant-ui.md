...
> **Related:** [live-preview.md](./live-preview.md) · [modules/ecommerce/seo/ARCHITECTURE.md](../../03-business-modules/ecommerce/seo/ARCHITECTURE.md)

---

## Purpose
Global UI standard: seo assistant ui.

## When To Read
Read only if working on UI patterns related to seo assistant ui.
