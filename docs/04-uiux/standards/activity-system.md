...
> **Core entities:** [core/entities/activities.md](../../02-core-platform/entities/activities.md) · [comments.md](../../02-core-platform/entities/comments.md) · [notes.md](../../02-core-platform/entities/notes.md)

---

## Purpose
Global UI standard: activity system.

## When To Read
Read only if working on UI patterns related to activity system.
