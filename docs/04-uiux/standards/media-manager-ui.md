...
> **Backend:** [modules/ecommerce/media/ARCHITECTURE.md](../../03-business-modules/ecommerce/media/ARCHITECTURE.md)

---

## Purpose
Global UI standard: media manager ui.

## When To Read
Read only if working on UI patterns related to media manager ui.
