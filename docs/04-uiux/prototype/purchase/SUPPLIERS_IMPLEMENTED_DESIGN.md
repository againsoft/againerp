...
Record view per [record-view.md](../../standards/record-view.md) and Purchase §4 Vendor UI.
...
**Parent:** [purchase/README.md](./README.md) · [IMPLEMENTED_DESIGN.md](../catalog/products/IMPLEMENTED_DESIGN.md) · [UI_PROTOTYPE_MODE.md](../../strategy/UI_PROTOTYPE_MODE.md)
