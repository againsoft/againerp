...
> **Architecture target:** [ECOMMERCE_STOREFRONT_ARCHITECTURE.md](../../../03-business-modules/ecommerce/ECOMMERCE_STOREFRONT_ARCHITECTURE.md)
...
- [ECOMMERCE_STOREFRONT_ARCHITECTURE.md](../../../03-business-modules/ecommerce/ECOMMERCE_STOREFRONT_ARCHITECTURE.md) — target architecture  
- [CHANGELOG.md](../../../00-foundation/CHANGELOG.md) — `2.42.0-storefront-prototype-ui`  
