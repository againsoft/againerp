...
> **UI:** [ENTERPRISE_UI_ARCHITECTURE.md](../standards/ENTERPRISE_UI_ARCHITECTURE.md)
...
- Module groups match [MENU_STRUCTURE.md](../../03-business-modules/ecommerce/MENU_STRUCTURE.md)
