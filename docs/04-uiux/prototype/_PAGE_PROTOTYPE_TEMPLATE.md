...
> **Architecture Doc:** [link](../03-business-modules/ecommerce/...)  
...
_Desktop + mobile. Reference [record-view](../standards/record-view.md) or list pattern._
...
| Component | Spec |
|-----------|------|
| Data table | [tables.md](../standards/tables.md) |
| Filter panel | [live-filters.md](../standards/live-filters.md) |
