...
## Purpose
Documentation: UI PROTOTYPE STRATEGY.

## When To Read
Read only if your task involves ui prototype strategy.
...
> **UI Standards:** [ui-ux/ENTERPRISE_UI_ARCHITECTURE.md](../standards/ENTERPRISE_UI_ARCHITECTURE.md) · [ui-ux/UX_SMART_INTERACTION_STANDARDS.md](../standards/UX_SMART_INTERACTION_STANDARDS.md)
...
Prototype docs live in [`ui-prototype/`](../prototype/README.md) — separate from architecture `Menus/` specs but cross-linked.
...
Template: [`ui-prototype/_PAGE_PROTOTYPE_TEMPLATE.md`](../prototype/_PAGE_PROTOTYPE_TEMPLATE.md)
...
**Detail:** [ui-prototype/DUMMY_DATA_STANDARDS.md](../prototype/DUMMY_DATA_STANDARDS.md)
...
4. [CHANGELOG.md](../../00-foundation/CHANGELOG.md)
...
| File | Purpose |
|------|---------|
| [MissingFeatures.md](../prototype/MissingFeatures.md) | Features discovered missing during prototype |
| [ReviewQuestions.md](../prototype/ReviewQuestions.md) | Open UX questions |
| [ImprovementIdeas.md](../prototype/ImprovementIdeas.md) | Enhancement ideas |
...
**Detail:** [ui-prototype/REVIEW_CYCLE.md](../prototype/REVIEW_CYCLE.md)
...
**Detail:** [ui-prototype/PRODUCTION_READINESS.md](../prototype/PRODUCTION_READINESS.md)
