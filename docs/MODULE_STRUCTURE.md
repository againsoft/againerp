...
Unlimited verticals install on Core — see [framework/INDUSTRY_MODULES.md](./framework/INDUSTRY_MODULES.md).
...
5. [ ] Create `AI.md` from [framework/templates/AI_TEMPLATE.md](./framework/templates/AI_TEMPLATE.md)
