...
## When To Read
Read only if your task involves plugin manifest.
...
| UI Prototype | [BankEmi.md](../../../04-uiux/prototype/plugins/BankEmi.md) |
| Storefront | [ECOMMERCE_STOREFRONT_ARCHITECTURE.md](../../../03-business-modules/ecommerce/ECOMMERCE_STOREFRONT_ARCHITECTURE.md) |
| Plugins home | [Plugins.md](../../../04-uiux/prototype/settings/Plugins.md) |
