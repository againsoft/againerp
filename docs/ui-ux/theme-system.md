...
> **Status:** Draft  
> **Standards:** [design-system.md](./design-system.md) · [dark-mode.md](./dark-mode.md) · [DEVELOPMENT_STANDARDS.md §9](../DEVELOPMENT_STANDARDS.md#9-multi-company-ready)
...
Document per [DEVELOPMENT_STANDARDS.md §9](../DEVELOPMENT_STANDARDS.md#9-multi-company-ready).
