...
> **Standards:** [DEVELOPMENT_STANDARDS.md §1](../DEVELOPMENT_STANDARDS.md#1-mobile-first-design) · [mobile-first.md](./mobile-first.md)
...
Aligned with [DEVELOPMENT_STANDARDS.md §1](../DEVELOPMENT_STANDARDS.md#1-mobile-first-design):
