...
> **Superseded by:** [COMPONENT_LIBRARY_STANDARD.md](./COMPONENT_LIBRARY_STANDARD.md) · [UI_ARCHITECTURE_LOCK.md](../../UI_ARCHITECTURE_LOCK.md) — APPROVED (Step 10)  
> **On conflict:** Step 10 standards win.  
> **Standards:** [DESIGN_TOKEN_STANDARD.md](./DESIGN_TOKEN_STANDARD.md) · [mobile-first.md](./mobile-first.md)

## Purpose
Global UI standard: components.

## When To Read
Read only if working on UI patterns related to components.
