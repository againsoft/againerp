...
Use **Vue 3** with Composition API for the AgainERP admin panel. UI follows [ENTERPRISE_UI_ARCHITECTURE.md](../../04-uiux/standards/ENTERPRISE_UI_ARCHITECTURE.md).
...
- [UI_PROTOTYPE_STRATEGY.md](../../04-uiux/strategy/UI_PROTOTYPE_STRATEGY.md)
