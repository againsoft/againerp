...
Audit AgainERP documentation against implemented code before launch. Ensures documentation remains the source of truth per [GOVERNANCE.md](../GOVERNANCE.md) and identifies gaps, drift, and outdated content.
...
Per module ([DOCUMENTATION_STANDARD.md](../DOCUMENTATION_STANDARD.md)):
...
- [ ] [_COMMIT_CHECKLIST.md](../_COMMIT_CHECKLIST.md) complete
...
- [_COMMIT_CHECKLIST.md](../_COMMIT_CHECKLIST.md)
