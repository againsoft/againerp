...
| [ai-assistant-ui.md](../../04-uiux/standards/ai-assistant-ui.md) | Assistant panel spec |
| [AI_OS_ARCHITECTURE.md](../platform/ai/AI_OS_ARCHITECTURE.md) | AI OS UI §18 |
| [ECOMMERCE_ADMIN_PROTOTYPE_PHASE1.md](../../04-uiux/strategy/ECOMMERCE_ADMIN_PROTOTYPE_PHASE1.md) | Current prototype baseline |
