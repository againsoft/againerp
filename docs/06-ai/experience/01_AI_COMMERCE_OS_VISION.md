...
|----------|--------------|
| [AI_OS_ARCHITECTURE.md](../platform/ai/AI_OS_ARCHITECTURE.md) | Technical architecture of the AI OS |
| [AI_FIRST_ARCHITECTURE.md](../platform/ai/AI_FIRST_ARCHITECTURE.md) | Platform-wide AI-first principles |
| [AI_AUDIT_AND_APPROVAL.md](../platform/ai/AI_AUDIT_AND_APPROVAL.md) | Governance implementation |
| [ECOMMERCE_STOREFRONT_ARCHITECTURE.md](../../03-business-modules/ecommerce/ECOMMERCE_STOREFRONT_ARCHITECTURE.md) | Customer-facing commerce layer |
| [GOVERNANCE.md](../../00-foundation/GOVERNANCE.md) | Documentation and change governance |
