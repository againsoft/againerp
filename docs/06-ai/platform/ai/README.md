...
| Document | Purpose |
|----------|---------|
| [**ai_os/README.md**](../../experience/README.md) | **Experience entry** — vision, admin, storefront, cross-cutting UX |
...
[ai-assistant-ui.md](../../../04-uiux/standards/ai-assistant-ui.md) · Ecommerce `Menus/AI/`
