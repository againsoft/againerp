...
---
## Purpose
Documentation: COMMUNICATION CONTRACTS.

## When To Read
Read only if your task involves communication contracts.
...
Global catalog: maintain in [MODULE_DEPENDENCY_MAP.md](../../01-architecture/MODULE_DEPENDENCY_MAP.md).  
Service contracts: [SERVICE_REGISTRY.md](../../00-foundation/registries/SERVICE_REGISTRY.md).
