...
## When To Read
Read only if your task involves optimization.
...
Admin dashboard widget load: < 2s per [ecommerce/dashboard/ARCHITECTURE.md](../../03-business-modules/ecommerce/dashboard/ARCHITECTURE.md).
...
- [core/engines/cache-architecture.md](../../02-core-platform/engines/cache-architecture.md)
