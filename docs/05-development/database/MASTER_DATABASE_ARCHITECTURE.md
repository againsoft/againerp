...
## Purpose
Documentation: MASTER DATABASE ARCHITECTURE.

## When To Read
Read only if your task involves master database architecture.
...
**Related:** [DATABASE_REGISTRY.md](../../00-foundation/registries/DATABASE_REGISTRY.md) · [standards.md](./standards.md) · [catalog/ARCHITECTURE.md](../../03-business-modules/ecommerce/catalog/ARCHITECTURE.md) · [orders/ARCHITECTURE.md](../../03-business-modules/ecommerce/orders/ARCHITECTURE.md) · [core/ARCHITECTURE.md](../../02-core-platform/ARCHITECTURE.md)
...
Contacts, addresses, media, tags, notes, comments, users, roles — **Core owns**. See [core/shared-entities.md](../../02-core-platform/shared-entities.md).
...
> Detail: [catalog/ARCHITECTURE.md](../../03-business-modules/ecommerce/catalog/ARCHITECTURE.md)
...
| `catalog_attribute_profiles` | Specification profiles (Laptop, Mobile…) — see [SPECIFICATIONS_ARCHITECTURE.md](../../03-business-modules/ecommerce/catalog/SPECIFICATIONS_ARCHITECTURE.md) |
...
> Detail: [orders/ARCHITECTURE.md](../../03-business-modules/ecommerce/orders/ARCHITECTURE.md)
...
**Conflict prevention:** New tables require entry in module `Database.md` + [MODULE_DEPENDENCY_MAP.md](../../01-architecture/MODULE_DEPENDENCY_MAP.md).
...
| [MASTER_DEVELOPMENT_SEQUENCE.md](../../10-roadmap/MASTER_DEVELOPMENT_SEQUENCE.md) | Phase 2 steps |
