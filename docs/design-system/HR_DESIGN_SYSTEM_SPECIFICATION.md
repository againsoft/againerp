...
> **Parent:** [HR_UI_UX_BLUEPRINT.md](../modules/hr-payroll/HR_UI_UX_BLUEPRINT.md) · [HR_FIGMA_WIREFRAME_BLUEPRINT.md](../modules/hr-payroll/HR_FIGMA_WIREFRAME_BLUEPRINT.md) · [uiux/HR_NAVIGATION_ARCHITECTURE.md](../modules/hr-payroll/uiux/HR_NAVIGATION_ARCHITECTURE.md) · [uiux/HR_DASHBOARD_UI_ARCHITECTURE.md](../modules/hr-payroll/uiux/HR_DASHBOARD_UI_ARCHITECTURE.md) · [uiux/EMPLOYEE_PROFILE_UI_ARCHITECTURE.md](../modules/hr-payroll/uiux/EMPLOYEE_PROFILE_UI_ARCHITECTURE.md) · [uiux/HR_APPROVAL_CENTER_UI_ARCHITECTURE.md](../modules/hr-payroll/uiux/HR_APPROVAL_CENTER_UI_ARCHITECTURE.md) · [uiux/HR_ACTIVITY_TIMELINE_UI_ARCHITECTURE.md](../modules/hr-payroll/uiux/HR_ACTIVITY_TIMELINE_UI_ARCHITECTURE.md)  
> **Governance:** [UI_UX_DESIGN_STANDARDS.md](../ui-ux/UI_UX_DESIGN_STANDARDS.md) · [ENTERPRISE_UI_ARCHITECTURE.md](../ui-ux/ENTERPRISE_UI_ARCHITECTURE.md) · [design-system.md](../ui-ux/design-system.md) · [components.md](../ui-ux/components.md) · [PROJECT_COMMON_RULES.md](../PROJECT_COMMON_RULES.md) · [SAAS_PLATFORM_ARCHITECTURE.md](../SAAS_PLATFORM_ARCHITECTURE.md) · [AI_OS_ARCHITECTURE.md](../modules/ai/AI_OS_ARCHITECTURE.md)
...
Aligned with [HR_UI_UX_BLUEPRINT.md](../modules/hr-payroll/HR_UI_UX_BLUEPRINT.md):
...
WCAG 2.1 AA minimum — per [design-system.md](../ui-ux/design-system.md):
...
Per [uiux/HR_AI_ASSISTANT_UI_ARCHITECTURE.md](../modules/hr-payroll/uiux/HR_AI_ASSISTANT_UI_ARCHITECTURE.md):
...
Semantic architecture — implementation via design tokens in [design-system.md](../ui-ux/design-system.md). **No raw hex in components.**
...
12-column dashboard grid — per [uiux/HR_DASHBOARD_UI_ARCHITECTURE.md](../modules/hr-payroll/uiux/HR_DASHBOARD_UI_ARCHITECTURE.md)
...
**Wireframe phase:** Gray placeholder boxes per [HR_FIGMA_WIREFRAME_BLUEPRINT.md](../modules/hr-payroll/HR_FIGMA_WIREFRAME_BLUEPRINT.md)

---

# Color System

See [status-system.md](../ui-ux/status-system.md) for universal status mapping.
...
Atomic design — aligns with [HR_FIGMA_WIREFRAME_BLUEPRINT.md](../modules/hr-payroll/HR_FIGMA_WIREFRAME_BLUEPRINT.md):
...
**Rule:** Text always present — per [status-system.md](../ui-ux/status-system.md)
...
**Employee profile:** 14 tabs per [EMPLOYEE_PROFILE_UI_ARCHITECTURE.md](../modules/hr-payroll/uiux/EMPLOYEE_PROFILE_UI_ARCHITECTURE.md)
...
Based on [uiux/HR_ACTIVITY_TIMELINE_UI_ARCHITECTURE.md](../modules/hr-payroll/uiux/HR_ACTIVITY_TIMELINE_UI_ARCHITECTURE.md):
...
From [uiux/HR_APPROVAL_CENTER_UI_ARCHITECTURE.md](../modules/hr-payroll/uiux/HR_APPROVAL_CENTER_UI_ARCHITECTURE.md):
...
Per [uiux/HR_NAVIGATION_ARCHITECTURE.md](../modules/hr-payroll/uiux/HR_NAVIGATION_ARCHITECTURE.md):
...
Per [uiux/HR_DASHBOARD_UI_ARCHITECTURE.md](../modules/hr-payroll/uiux/HR_DASHBOARD_UI_ARCHITECTURE.md):
...
**Wireframe fidelity:** Grayscale zones per [HR_FIGMA_WIREFRAME_BLUEPRINT.md](../modules/hr-payroll/HR_FIGMA_WIREFRAME_BLUEPRINT.md)  
...
|----------|--------------|
| [design-system.md](../ui-ux/design-system.md) | Token implementation target |
| [components.md](../ui-ux/components.md) | Component catalog |
| [status-system.md](../ui-ux/status-system.md) | Badge tokens |
| [mobile-first.md](../ui-ux/mobile-first.md) | Responsive patterns |
| [ai-assistant-ui.md](../ui-ux/ai-assistant-ui.md) | AI panel |
| [dashboard-widgets.md](../ui-ux/dashboard-widgets.md) | Widget registry |
| [HR_MODULE_MASTER_INDEX.md](../modules/hr-payroll/HR_MODULE_MASTER_INDEX.md) | Doc registry |
