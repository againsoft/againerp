...
> **Supersedes:** ADR-002 (Laravel), ADR-003 (Vue) — see [ADR_INDEX.md](./ADR_INDEX.md)
...
**UI architecture:** [ui-ux/ENTERPRISE_UI_ARCHITECTURE.md](./ui-ux/ENTERPRISE_UI_ARCHITECTURE.md)
...
**API standards:** [api/README.md](./api/README.md) · [API_REGISTRY.md](./API_REGISTRY.md)
...
**Schema:** [database/MASTER_DATABASE_ARCHITECTURE.md](./database/MASTER_DATABASE_ARCHITECTURE.md) · [DATABASE_REGISTRY.md](./DATABASE_REGISTRY.md)
...
Media via Core `MediaService` — [core/entities/media-library.md](./core/entities/media-library.md)
...
**Architecture:** [modules/ai/AI_OS_ARCHITECTURE.md](./modules/ai/AI_OS_ARCHITECTURE.md) · [AI_KNOWLEDGE_INDEX.md](./AI_KNOWLEDGE_INDEX.md)
...
| No feature without documentation | Register in [DOCUMENT_REGISTRY.md](./DOCUMENT_REGISTRY.md) |
...
Full spec: [ui-ux/ENTERPRISE_UI_ARCHITECTURE.md](./ui-ux/ENTERPRISE_UI_ARCHITECTURE.md)
...
Registry: [API_REGISTRY.md](./API_REGISTRY.md)
...
Full standards: [DEVELOPMENT_STANDARDS.md](./DEVELOPMENT_STANDARDS.md)
...
Plus registries: [DOCUMENT_REGISTRY.md](./DOCUMENT_REGISTRY.md) · [MODULE_REGISTRY.md](./MODULE_REGISTRY.md)
...
Also read: [README.md](./README.md) → [MASTER_INDEX.md](./MASTER_INDEX.md) → [PROJECT_MAP.md](./PROJECT_MAP.md) → [AI_KNOWLEDGE_INDEX.md](./AI_KNOWLEDGE_INDEX.md)
...
**Roadmap:** [platform/SCALING_ROADMAP.md](./platform/SCALING_ROADMAP.md) · [SAAS_PLATFORM_ARCHITECTURE.md](./SAAS_PLATFORM_ARCHITECTURE.md)
...
3. Update [ADR_INDEX.md](./ADR_INDEX.md)
