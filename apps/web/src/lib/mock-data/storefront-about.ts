...
export const aboutContent = {
  ...
  founded: "2024",
  mission:
    "AgainShop makes quality products accessible across Bangladesh — with honest pricing, fast delivery, and support you can actually reach.",
  story: [
    "AgainShop started as the customer-facing storefront for AgainERP — one platform connecting catalog, inventory, orders, and fulfillment for modern retailers.",
  ...
  teamNote:
    "We're a small, focused team in Dhaka — engineers, merchandisers, and support specialists who use AgainERP every day to run this store.",
};
