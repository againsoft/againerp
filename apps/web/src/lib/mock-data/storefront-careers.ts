...
export const CAREER_BENEFITS = [
  ...
  { title: "AgainShop discount", body: "30% staff discount on all products." },
];
...
export const jobOpenings: JobOpening[] = [
  ...
  },
  {
    ...
    location: "Remote",
    type: "Full-time",
    summary: "Write blog posts, manage campaigns, and grow AgainShop's brand across social channels.",
  },
  {
    id: "job6",
