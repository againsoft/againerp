...
export const cmsPages: CmsPage[] = [
  {
    ...
    metaTitle: "Warranty Policy — AgainShop",
    metaDescription: "Warranty terms for products purchased from AgainShop.",
    updatedAt: "2026-06-13",
    body: [
      "This warranty applies to products purchased from AgainShop and our official outlets.",
  ...
  },
  {
    ...
    metaTitle: "Privacy Policy — AgainShop",
