...
import {
  ArrowLeft, Camera, CheckCircle2, Edit2, ExternalLink,
  ImageIcon, MessageSquare, Shield, Star, ThumbsDown, ThumbsUp,
  Video, XCircle, FileText,
} from "lucide-react";
import { toast } from "sonner";
import { useReviewStore } from "@/lib/store/review-store";
import { REVIEW_STATUS_LABELS, type ReviewStatus } from "@/lib/mock-data/reviews";
...
export function ReviewDetailWorkspace({ reviewId }: Props) {
