...
export function OrdersDashboard() {
  ...
  const kpis = [
    { label: "Total Orders", value: ordersDashboardKpis.totalOrders.toLocaleString(), change: "+8.2%", up: true, icon: Package },
    { label: "Today's Orders", value: String(ordersDashboardKpis.todayOrders), change: "+12 today", up: true, icon: TrendingUp },
    { label: "Pending", value: String(ordersDashboardKpis.pending), change: "Needs action", up: false, icon: Package },
    { label: "Shipped", value: String(ordersDashboardKpis.shipped), change: "+5%", up: true, icon: Truck },
    { label: "Revenue", value: formatCurrency(ordersDashboardKpis.revenue), change: "+14.1%", up: true, icon: TrendingUp },
    { label: "Avg Order Value", value: formatCurrency(ordersDashboardKpis.aov), change: "+3.2%", up: true, icon: TrendingUp },
  ];

  const pipelineTotal = ordersStatusPipeline.reduce((s, p) => s + p.count, 0);
