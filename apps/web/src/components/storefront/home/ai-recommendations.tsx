...
export function AiRecommendations({ products }: AiRecommendationsProps) {
  return (
    <section id="ai-picks" className="rounded-2xl border border-violet-200/60 bg-gradient-to-br from-violet-50/80 to-indigo-50/50 p-5 dark:border-violet-900/40 dark:from-violet-950/30 dark:to-indigo-950/20 sm:p-6">
      <SectionHeader
