              ...
              return (
                <tr key={page.id} className="hover:bg-muted/30 transition-colors">
                  ...
                  <td className="px-4 py-3 hidden md:table-cell">
                    {hasTitle ? (
                      <p className="text-[12px] text-foreground line-clamp-1">{page.title} | AgainERP</p>
                    ) : (
                  ...
                  <td className="px-4 py-3 hidden lg:table-cell">
                    {hasDesc ? (
                      <p className="text-[12px] text-muted-foreground line-clamp-1">Discover {page.title.toLowerCase()} on AgainERP platform.</p>
                    ) : (
                      <p className="text-[11px] text-red-500 italic">Missing</p>
                    )}
                  </td>
